...
JSCal.Range = function(opt) {
    ...
    this.countVal_set = function() {
        ...
        opts.countVal = Math.ceil((opts.endDateTime - opts.startDateTime) / (one_day));
    ...
    if (opts.startDateInt != null) $(opts.startCont).val("" + opts.startDateInt)
    if (opts.endDateInt != null) $(opts.endCont).val("" + opts.endDateInt)
