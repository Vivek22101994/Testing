...
JSCal.Range = function(opt) {
    ...
    if ($(opts.endCont).val() != "" && $(opts.endCont).val() != "0" && $(opts.endCont).val() != "00000000")
        ...
        opts.endDateInt = 0;
    opts.startCal = $(opts.startView).datepicker({ showAnim: "", changeMonth: opts.changeMonth, changeYear: opts.changeYear, showOtherMonths: opts.showOtherMonths, selectOtherMonths: opts.selectOtherMonths, dateFormat: opts.dtFormat, altField: opts.startCont, altFormat: "yymmdd", onSelect: function(selectedDate) { var instance = $(this).data("datepicker"); var date = $.datepicker.parseDate(instance.settings.dateFormat || $.datepicker._defaults.dateFormat, selectedDate, instance.settings); obj.startCal_onSelect(date); }, beforeShowDay: function(date) { return obj.beforeShowDay(date); } });
...
""))+'"'+((!C||v)&&G[2]?' title="'+G[2]+'"':"")+(J?"":' onclick="DP_jQuery_'+y+".datepicker._selectDay('#"+a.id+"',"+q.getMonth()+","+q.getFullYear()+', this);return false;"')+">"+(G[3]?''+G[3]+'':"")+(C&&!v?"&#xa0;":J?'<span class="ui-state-default">'+q.getDate()+"</span>":'<a class="ui-state-default'+(q.getTime()==b.getTime()?" ui-state-highlight":"")+(q.getTime()==u.getTime()?" ui-state-active":"")+(C?" ui-priority-secondary":"")+'" href="#">'+q.getDate()+"</a>")+"</td>";q.setDate(q.getDate()+1);q=this._daylightSavingAdjust(q)}x+=
