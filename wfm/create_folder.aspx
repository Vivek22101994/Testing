<%@ Page Title="" Language="C#" MasterPageFile="~/wfm/MP.Master" AutoEventWireup="true" CodeBehind="create_folder.aspx.cs" Inherits="WebFileManager.wfm.create_folder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_main" runat="server">
		...
		<table>
			...
			<tr>
				<td>
					<asp:TextBox ID="txt_folder_name" runat="server"></asp:TextBox><br />
					<asp:Button ID="btn_create" runat="server" Text="Crea" OnClick="btn_create_Click" />
				</td>
			</tr>
		</table>
</asp:Content>
