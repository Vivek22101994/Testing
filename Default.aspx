<%@ Page Title="" Language="C#" MasterPageFile="~/common/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="RentalInRome._Default" %>
                ...
                <ItemTemplate>
                    <li>
                        ...
                        <div class="informationbox">
                            <h3 class="animate fadeInRight"><%# contUtils.getLabel("lblAptInCity").Replace("#aptname#",Eval("title")+"").Replace("#cityname#", CurrentSource.loc_cityTitle(Eval("pid_city").objToInt32(), App.LangID,""))  %></h3>
                            <p class="animate fadeInRight textline"><%# contUtils.getLabel("lblPricePerNight").Replace("#price#", rntUtils.rntEstate_minPrice(Eval("id").objToInt32()).objToDecimal().ToString("N2")) %></p>
                            <a class="animate fadeInRight button" href="<%# Eval("page_path") %>"><%# contUtils.getLabel("reqBookNow") %></a>
                        </div>
                    </li>
                </ItemTemplate>
            </asp:ListView>
    ...
    <asp:PlaceHolder ID="phSpecialOffer" runat="server">
        <div class="parallax pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="section-title" data-animation-direction="from-bottom" data-animation-delay="50" style="color: #fff; text-shadow: 0 0 5px #000; font-size: 35pt;"><%= contUtils.getLabel("lblSpecialOffers1") %></h2>
                            ...
                            <asp:ListView ID="LVSpecialOffers" runat="server">
                                <ItemTemplate>
                                    <div class="item">
                                        ...
                                        <div class="price">
                                            <div class="discountHome">-<%# Eval("spDiscountAmount") %>%</div>
                                            <i class="fa fa-money"></i><%# contUtils.getLabel("lblDailyPriceFrom") %>:
                                             <span>€<%# Eval("spDiscountedAmount").objToDecimal().ToString("N2") %></span>
                                            <span class="offerPeriodHome"><%# contUtils.getLabel("lblDateFrom") %> <%# Eval("spDiscountDateStart") != null ? Convert.ToDateTime(Eval("spDiscountDateStart") + "").ToString("dd/MM/yyyy"): "" %> <%# contUtils.getLabel("lblDateTo") %> <%# Eval("spDiscountDateEnd") != null ? Convert.ToDateTime(Eval("spDiscountDateEnd") + "").ToString("dd/MM/yyyy"): "" %></span>
                                        </div>

                                        <div class="info">
                                            <%# (Convert.ToBoolean(Eval("isBP"))==true?"<img src='/images/css/best-price-guarantee.png' class='bestPrice' alt='Best Price Guarantee' />":"") %>


                                            <h3><a href="/<%# Eval("page_path") %>"><%# Eval("title") %></a></h3>
                                            <p><%# Eval("summary") %></p>
                                            <a href="<%# Eval("page_path") %>" class="btn btn-default"><%# contUtils.getLabel("lblReadMore") %></a>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:ListView>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-sm-8">
                    <h2 style="font-size: 21pt;" class="section-title" data-animation-direction="from-bottom" data-animation-delay="50"><%= contUtils.getLabel("lblZonesOfRome") %></h2>
                ...
                <div class="sidebar col-sm-4">
                    ...
                    <!-- BEGIN SIDEBAR ABOUT -->
                    <div class="col-sm-12">
                        <h1 class="section-title" style="font-size: 17pt;" data-animation-direction="from-bottom" data-animation-delay="50"><%=currStp.title %></h1>
                ...
                <div class="row focusOnHomeCont">
                    ...
                    <h2 style="font-size: 21pt;" class="section-title" data-animation-direction="from-bottom" data-animation-delay="50">Focus on...</h2>
                    ...
                    <div id="latest-news-slider" class="focusOnHome owl-carousel latest-news-slider" data-animation-direction="from-bottom" data-animation-delay="250">
                        ...
                        <div class="item">
                            <div class="image">
                                ...
                                <img src="/images/long-term.jpg" alt="" />
                            </div>
                        ...
                        <div class="item">
                            <div class="image">
                                ...
                                <img src="/images/transfer-pickup.jpg" alt="" />
                            </div>
...
div.overlay2 .close {
	background-image:url(/images/css/close2.png);
	cursor:pointer;
	height:35px;
	position:absolute;
	right: 12px;
...
<div class="overlay2" id="apple3">
       
           <img src="/images/<%=CurrentSource.getSysLangValue("lbl_img_banner_blackfriday")%>" alt="Rental in Rome Black Friday Week 2016" />
...
<script type="text/javascript">
    ...
    $("#apple3").overlay({ effect: 'default', api: true }).load();
    setTimeout('apple3_hide()', 30000);
