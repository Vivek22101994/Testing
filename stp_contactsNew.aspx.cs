...
{
    public partial class stp_contactsNew : contStpBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                ErrorLog.addLog(_ip, "stp_contactsNew", _params);
        ...
        protected void setPlaceHolder()
        {
            ...
            txt_dtCount.Attributes.Add("placeholder", CurrentSource.getSysLangValue("lblNights") + "*");
        ...
        {
            List<LOC_VIEW_ZONE> _list = AppSettings.LOC_ZONEs.Where(x => x.pid_lang == CurrentLang.ID && AppSettings.RNT_activeZones.Contains(x.id)).OrderBy(x => x.title).ToList();
            LV_Area.DataSource = _list;
        ...
        protected void Fill_data()
        {
            ...
            // drp_persons
            int _max = AppSettings.RNT_TB_ESTATE.Where(x => x.num_persons_max.HasValue).Max(x => x.num_persons_max.Value);
            ...
            ltr_Price1.Text = CurrentSource.getSysLangValue("reqPriceRange1");
            ltr_Price2.Text = CurrentSource.getSysLangValue("reqPriceRange2");
            ltr_Price3.Text = CurrentSource.getSysLangValue("reqPriceRange3");
            ltr_Price4.Text = CurrentSource.getSysLangValue("reqPriceRange4");
            ...
            ltr_service_1.Text = CurrentSource.getSysLangValue("reqServices1");
            ltr_service_2.Text = CurrentSource.getSysLangValue("reqServices2");
            ltr_service_3.Text = CurrentSource.getSysLangValue("reqServices3");
            ltr_service_4.Text = CurrentSource.getSysLangValue("reqServices4");
        ...
        protected void saveRequest()
        {
            ...
            string _area = "";
            _br = "";
            foreach (ListViewItem _item in LV_Area.Items)
            {
                CheckBox cb = _item.FindControl("chkArea") as CheckBox;

                if (cb.Checked)
                {
                    Label lbl_title = _item.FindControl("lbl_title") as Label;
                    _area += _br + lbl_title.Text;
                    _br = "<br/>";
                }
            }
            ...
            if (chkPrice_1.Checked)
            {
                _price_range += _br + ltr_Price1.Text;
                _br = "<br/>";
            }

            if (chkPrice_2.Checked)
            {
                _price_range += _br + ltr_Price2.Text;
                _br = "<br/>";
            }

            if (chkPrice_3.Checked)
            {
                _price_range += _br + ltr_Price3.Text;
                _br = "<br/>";
            }
            if (chkPrice_4.Checked)
            {
                _price_range += _br + ltr_Price4.Text;
                _br = "<br/>";
            }
            ...
            if (chkService_1.Checked)
            {
                _services += _br + ltr_service_1.Text;
                _br = "<br/>";
            }

            if (chkService_2.Checked)
            {
                _services += _br + ltr_service_2.Text;
                _br = "<br/>";
            }

            if (chkService_3.Checked)
            {
                _services += _br + ltr_service_3.Text;
                _br = "<br/>";
            }
            if (chkService_4.Checked)
            {
                _services += _br + ltr_service_4.Text;
                _br = "<br/>";
            }
        ...
        {
            drp_country.Items.Insert(0, new ListItem(CurrentSource.getSysLangValue("reqLocation") + "*", "0"));
            if (CurrentLang.ID != 2)
            {
