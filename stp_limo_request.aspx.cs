...
{
    public partial class stp_limo_request : mainBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                ErrorLog.addLog(_ip, "stp_limo_request", _params);
        ...
        protected void Fill_data()
        {
            ...
            HF_in_date.Value = _dtStart.JSCal_dateToString();
            HF_out_date.Value = _dtEnd.JSCal_dateToString();
            // page details
            CONT_VIEW_STP _stp =
            ...
            drp_num_adult.bind_Numbers(1, 10, 1, 0);
            drp_num_adult.setSelectedValue("2");
            drp_num_child_over.bind_Numbers(0, 10, 1, 0);
            drp_num_child_min.bind_Numbers(0, 10, 1, 0);
        ...
        protected void saveRequest()
        {
            ...
            if (drp_trip_mode.getSelectedValueInt(0) == 2 || drp_trip_mode.getSelectedValueInt(0) == 3)
            {
                ...
                _mailBody += MailingUtilities.addMailRow("Arrival time", "" + HF_out_time_cont.Value.JSTime_stringToTime().JSTime_toString(false, true), alternateOld, out alternateOld, false, false, false);
