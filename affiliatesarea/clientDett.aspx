<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master" AutoEventWireup="true" CodeBehind="clientDett.aspx.cs" Inherits="RentalInRome.affiliatesarea.clientDett" %>
    ...
    <telerik:RadAjaxPanel ID="pnlDett" runat="server">
        ...
        <div class="salvataggio">
            <div class="bottom_salva">
                <asp:LinkButton ID="lnkSave" runat="server" ValidationGroup="dati" OnClick="lnkSave_Click"><span><%=CurrentSource.getSysLangValue("lblSaveChanges")%></span></asp:LinkButton></div>
            <div class="bottom_salva">
                <asp:LinkButton ID="lnkCancel" runat="server" OnClick="lnkCancel_Click"><span><%=CurrentSource.getSysLangValue("lblCancelChanges")%></span></asp:LinkButton></div>
            <div class="bottom_salva">
