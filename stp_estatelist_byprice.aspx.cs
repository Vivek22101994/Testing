...
{
    public partial class stp_estatelist_byprice : mainBasePage
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                ErrorLog.addLog(_ip, "stp_estatelist_byprice", _params);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                HF_currPriceRange.Value = Request.QueryString["range"];
                Fill_data();
            }
        }
