<%@ Page Title="" Language="C#" MasterPageFile="~/common/MP_main.Master" AutoEventWireup="true" CodeBehind="pg_rntEstateDett.aspx.cs" Inherits="RentalInRome.pg_rntEstateDett" %>
    ...
    <div id="schedaDett">
        ...
        <div id="media">
            <div id="bannerApt">
                ...
                <img src="/images/css/default-apt-banner.jpg" realsrc="<%=((currEstateTB.img_banner + "").Trim() != "") ? IMG_ROOT + currEstateTB.img_banner + "?tmp=" + DateTime.Now.Ticks : "/images/css/default-apt-banner.jpg"%>" alt="<%=CurrentSource.locZone_title(HF_pid_zone.Value.objToInt32(), CurrentLang.ID, "")%> - <%=currEstateLN.title%>" />
            </div>
            ...
            <div id="tastiMedia">
                <ul class="mediaul">
                    ...
                    <%} %>
                    <asp:ListView ID="LV_videoToggler" runat="server" ViewStateMode="Disabled">
                        <ItemTemplate>
                            <li>
