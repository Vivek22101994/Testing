<%@ Page Title="" Language="C#" MasterPageFile="~/common/Main.Master" AutoEventWireup="true" CodeBehind="stp_estatelist_bycatNew.aspx.cs" Inherits="RentalInRome.stp_estatelist_bycatNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_head_bottom" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AjaxList_fillList(action, fromLoadMore) {
            ...
            var url = "/webserviceNew/rntEstateSearchCat.aspx";
            var jsondata = {};
            jsondata.lang = "<%= App.LangID %>";
            jsondata.SESSION_ID = "<%= CURRENT_SESSION_ID %>";
            jsondata.currCat = $("#<%= HF_category.ClientID %>").val();
