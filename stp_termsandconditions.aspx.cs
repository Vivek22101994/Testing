...
{
    public partial class stp_termsandconditions : mainBasePage
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                ErrorLog.addLog(_ip, "stp_termsandconditions", _params);
        ...
        protected void Fill_data()
        {
            ...
            if (_stp != null)
            {
                string url_voucher = CurrentAppSettings.HOST + CurrentAppSettings.ROOT_PATH + "stp_contentonly.aspx?id=" + PAGE_REF_ID + "&lang=" + CurrentLang.ID;
                string filename = "RiR_" + _stp.title.clearPathName() + ".pdf";

                HL_getPdf.Visible = true;
                HL_getPdf.Enabled = true;
                HL_getPdf.CssClass = "btnDownload";
