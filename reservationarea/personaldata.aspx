...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_main" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <div id="pnl_request_cont" class="box_client_booking" runat="server" style="width: 545px;">
                        ...
                        <div class="line" style="border: none;">
                            ...
                            <div id="txt_loc_province_cont" class="left">
                                <label class="desc">
                                    <%=CurrentSource.getSysLangValue("locProvince")%>*
                                </label>
                                <div>
                                    <asp:TextBox ID="txt_loc_province" runat="server" MaxLength="10"></asp:TextBox>
                                    <span id="txt_loc_province_check" class="alertErrorSmall" style="width: 160px; float: none; display: none;">
                                        <%=CurrentSource.getSysLangValue("reqRequiredField")%></span>
                                </div>
                            </div>
                        ...
                        <div class="line" style="border: none;">
                            ...
                            <div id="txt_contact_email_cont" class="left">
                             ...
                             <div id="Div13" class="left">
                                <label class="desc">
                                    <%=contUtils.getLabel("lblIdDestinatario") %>
                                </label>
                                <div>
                                    <asp:TextBox ID="txt_id_codice" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="nulla">
                            </div>
    ...
    <script type="text/javascript">
        function RNT_validateRequestForm() {
            ...
            $("#txt_loc_province_check").hide();
            $("#<%= txt_loc_province.ClientID%>").removeClass(FORM_errorClass);
            if ($.trim($("#<%= txt_loc_province.ClientID%>").val()) == "") {
                $("#<%= txt_loc_province.ClientID%>").addClass(FORM_errorClass);
                $("#txt_loc_province_check").css("display", "block");
                _validate = false;
            }
