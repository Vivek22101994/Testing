<%@ Page Title="" Language="C#" MasterPageFile="~/common/Main.Master" AutoEventWireup="true" CodeBehind="pg_zone_details_new.aspx.cs" Inherits="RentalInRome.pg_zone_details_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_head_bottom" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AjaxList_fillList(action, fromLoadMore) {
            ...
            jsondata.currZone = $("#<%= HF_id.ClientID %>").val();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    AjaxList_fillFltList("checkbox", "fltExtrasList", data.fltExtrasList, '', '<%=contUtils.getLabel("lblFilterAminities") %>');
                ...
                <div class="main col-sm-7">
                    ...
                    <div class="parallax pattern-bg zoneDescriptionBox" data-stellar-background-ratio="0.5" style="background-image: url(/<%= ltr_img_banner.Text%>);">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h1 class="section-title" data-animation-direction="from-bottom" data-animation-delay="50"><%=CurrentSource.getSysLangValue("lblApartmentsInRome")%><br />
                                        <%= ltr_title.Text%></h1>
                    ...
                    <div class="clearfix" id="listing-header">
                        <div class="form-control-small">
                            <select id="sort_by" name="sort_by" data-placeholder="Sort">
                                <option value=""></option>
                                <option value="price"><%= contUtils.getLabel("lblSortByPrice") %></option>
                                <option value="name"><%= contUtils.getLabel("lblSortByName") %></option>
                            </select>
                        </div>
                        ...
                        <button id="filtersListBtn" class="btn btn-default-color btn_filters_list openFiltersList" type="button">
                            <%= contUtils.getLabel("lblFilter") %> <i class="fa fa-sort-desc"></i>
                        </button>
                    ...
                    <div id="filtersListCont" class="sidebar gray filtersListCont">
                        ...
                        <h2 class="section-title" style="padding-left: 15px;"><%= contUtils.getLabel("lblFilterResult") %></h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-default-color" onclick="setFltValues(); return false;"><%= contUtils.getLabel("lblFilter") %></button>
                            </div>
                            <div class="nulla">
                            </div>
                        </div>
                        ...
                        <ItemTemplate>
                            <div class="item col-md-4" data-animation-direction="from-bottom" data-animation-delay="200">
                                ...
                                <ul class="amenities numAptsZoneHome">
                                    <li><i class="icon-house"></i><%# Eval("Count") %> Apartments</li>
                                </ul>
                            </div>
