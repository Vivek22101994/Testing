<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pdf_rnt_reservation_invoice.aspx.cs" Inherits="RentalInRome.pdfgenerator.pdf_rnt_reservation_invoice" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin: 0 auto; width: 960px; position: relative;">
            <div id="pagato" class="sopra" style="display: none; left: 374px;">
                <img src="paid.png" alt="" style="width: 168px;" />
            </div>
        ...
        <tr>
            ...
            <td valign="middle" align="right" style="border-right: none;">
                ...
                <tr>
                    <td valign="middle" align="left" class="totFattura">
                        <strong>
                            <%=CurrentSource.getSysLangValue("pdf_InvoiceTotal", "Total")%>:</strong>
                    </td>
            ...
            <table width="960" cellpadding="20" cellspacing="0" border="0" style="margin-top: 25px;">
                 <tr>
                     <td><p>Payment Instructions:</p></td>
                     <td>Bank Account No. IT96Q0326803203052896314140</td>
                     <td>Swift Code: SELBIT2B </td>
                     <td>Account held to: Rental In Rome Srl</td>
                     <td>Bank Name: Banca Sella Via Angelo Emo</td>
                     <td>91 – 00136 - Roma (Italy)</td>
                 </tr>
            </table>            
            <table width="960" cellpadding="20" cellspacing="0" border="0" style="margin-top: 25px;">
                <tr>
