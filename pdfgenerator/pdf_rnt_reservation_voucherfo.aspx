<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pdf_rnt_reservation_voucherfo.aspx.cs" Inherits="RentalInRome.pdfgenerator.pdf_rnt_reservation_voucherfo" %>
        ...
        <table width="960" cellpadding="0" cellspacing="5" border="0">
            ...
            <tr>
                ...
                <td colspan="4" align="right" style="font-size: 13px;">
                    <b>
                        <%= (tblReservation.pr_part_owner.objToDecimal()-(tblReservation.agentDiscountNotPayed.objToInt32()==1?0:tblReservation.agentCommissionPrice.objToDecimal())).ToString("N2") + "&nbsp;&euro;"%></b>
                </td>
            </tr>
