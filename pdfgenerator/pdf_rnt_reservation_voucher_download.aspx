<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pdf_rnt_reservation_voucher_download.aspx.cs" Inherits="RentalInRome.pdfgenerator.pdf_rnt_reservation_voucher_download" %>
...
<body>
    ...
    <div id="container" style="clear:both;">
        <table width="960" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td valign="middle" align="left">
                  ...
                  {%>
                    <img src="logo.gif" title="Rent apartments in Rome, Italy" alt="Rent apartments in Rome, Italy" style="margin-bottom: 10px;" />
                    <%} %>
                    <%if (tblEstate.pid_city == 2)
                  {%>
                    <img src="logo_RiF.gif" title="Rent apartments in Florence, Italy" alt="Rent apartments in Florence, Italy" style="margin-bottom: 10px;" />
                    <%} %>
                    <%if (tblEstate.pid_city == 3)
                  {%>
                    <img src="logo_RiV.gif" title="Rent apartments in Venice, Italy" alt="Rent apartments in Venice, Italy" style="margin-bottom: 10px;" />
                    <%} %>
                </td>
                <td rowspan="2">
        ...
        <table width="960" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td id="Td1" colspan="5" runat="server" visible="false">
                    <b>
        ...
        <hr />
        <br/>
        <img src="Banner-Rome-Free-Lounge.jpg" style="width:100%; clear:both;" alt="Bag Storage only for the Rental In Rome guests for 3 Euro Full Day" />
        <br/><br/>
        <hr />
        <table width="960" cellpadding="0" cellspacing="0" border="0">
            <tr>
        ...
        <hr />
        <table id="Table1" width="960" cellpadding="0" cellspacing="0" border="0" runat="server" visible="false">
            <tr>
                <td colspan="10" style="font-size: 13px;">
                    <b>
