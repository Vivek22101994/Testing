<%@ Page Language="C#" MasterPageFile="~/common/MP_main.Master" AutoEventWireup="true" CodeBehind="pg_zone_details.aspx.cs" Inherits="RentalInRome.pg_zone_details" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_main" runat="server">
    ...
    <div class="banner_lista">
        ...
        <div class="numapt_zona">
            <%=string.Format(CurrentSource.getSysLangValue("lblWeHaveAptsInZone_format"), CurrentSource.locZone_countEstate(PAGE_REF_ID), ltr_title.Text)%>
        </div>
