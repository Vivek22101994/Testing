<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/areariservataprop/common/MP.Master" AutoEventWireup="true" CodeBehind="rnt_estate_config.aspx.cs" Inherits="RentalInRome.areariservataprop.rnt_estate_config" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="titolo_main" style="color: #FE6634;">Accessori della struttura:
                    ...
                    <div class="center">
                        <div class="boxmodulo">
                            <table border="0" cellspacing="3" cellpadding="0">
                                <tr>
                                    <td>
                                        <asp:LinqDataSource ID="LDS" runat="server" OrderBy="inner_notes" ContextTypeName="RentalInRome.data.magaRental_DataContext" TableName="RNT_TB_CONFIGs" Where="inner_type == @inner_type &amp;&amp; inner_category == @inner_category">
                                            <WhereParameters>
