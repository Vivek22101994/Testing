<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/areariservataprop/common/MP.Master" AutoEventWireup="true" CodeBehind="rnt_estate_point.aspx.cs" Inherits="RentalInRome.areariservataprop.rnt_estate_point" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="titolo_main" style="color: #FE6634;">
        Punti d'interesse della struttura:
