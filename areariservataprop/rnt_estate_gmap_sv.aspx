<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/areariservataprop/common/MP.Master" AutoEventWireup="true" CodeBehind="rnt_estate_gmap_sv.aspx.cs" Inherits="RentalInRome.areariservataprop.rnt_estate_gmap_sv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="titolo_main" style="color: #FE6634;">Gestione StreetView della struttura: <asp:Literal ID="ltr_title" runat="server"></asp:Literal></h1>
    <div id="fascia1">
