...
themeTable.button = {
	...
	rentalBtn = {
		default = assetDir .. "button/rental/default.png",
		over = assetDir .. "button/rental/over.png",
		width = 135, height = 45,
		font = "Arial",
		fontSize = 40,
