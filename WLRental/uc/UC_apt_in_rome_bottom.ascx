<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_apt_in_rome_bottom.ascx.cs" Inherits="RentalInRome.WLRental.uc.UC_apt_in_rome_bottom" %>
...
<asp:ListView ID="LV_zoneHome" runat="server">
    <ItemTemplate>
        <a class="zonaHome <%# "" + Eval("Id")=="9"?"zona_new":""%>" href="<%# Eval("Path") %>">
            <%# "" + Eval("Id")=="9" && 1==2 ?"<span class=\"ico_new\"></span>":""%>
            <span class="contimg">
                <img src="/WLRental/images/zone_thumb.jpg" alt="<%# Eval("Title") %>" id="_zoneList_img_<%# Eval("Id") %>" />
            </span>
