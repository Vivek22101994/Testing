<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucBooking.ascx.cs" Inherits="RentalInRome.WLRental.uc.ucBooking" %>
    ...
    <ContentTemplate>
                            ...
                            <div>
                                ...
                                <div class="anticiposaldo_div">
                                    <table cellspacing="0" cellpadding="0">
                                        <%if (1 == 2 && currOutPrice.agentCommissionPrice > 0)
                                        {%>
                                        <tr>
                                ...
                                <% if (1==2 && currOutPrice.agentID != 0 && currOutPrice.agentCommissionPrice != 0)
                                   { %>
        ...
        <div class="box_client_booking" id="pnl_sendBooking" runat="server" visible="false">
            ...
            <asp:PlaceHolder ID="PH_bookingForm" runat="server">
                ...
                <!-- INFO PAGAMENTO -->
                <div id="Div2" class="infopagbottom" runat="server" visible="false">
                    <div class="arrow">
                    </div>
                    <div class="box">
