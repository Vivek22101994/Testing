<%@ Page Title="" Language="C#" MasterPageFile="~/WLRental/common/MP_WLRental.Master" AutoEventWireup="true" CodeBehind="pg_zone_details.aspx.cs" Inherits="RentalInRome.WLRental.pg_zone_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_head_bottom" runat="server">
    <script type="text/javascript">
        ...
        function RNT_fillList(action) {
            ...
            var _url = "/webservice/rnt_estateListZone.aspx";
            _url += "?SESSION_ID=<%= CURRENT_SESSION_ID %>";
            _url += "&lang=<%= CurrentLang.ID %>";
            _url += "&currZone=" + $("#<%= HF_id.ClientID %>").val();
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_main" runat="server">
    ...
    <div class="banner_lista">
        ...
        <div class="numapt_zona">
            <%=string.Format(CurrentSource.getSysLangValue("lblWeHaveAptsInZone_format"), CurrentSource.locZone_countEstate_WL(PAGE_REF_ID), ltr_title.Text)%>
        </div>
    ...
    <div id="lista_search" class="zona">
        <div class="sx">
            <div class="txt_zone">
                <div>
                    <span class="txt_tit">
                        <span style="font-style: italic; color: #807487;">
                            <%=CurrentSource.getSysLangValue("lblTheArea")%><br />
                        </span>
                        <%= ltr_title.Text%>
                    </span>
