<%@ Page Title="" Language="C#" MasterPageFile="~/WLRental/common/MP_WLRental.Master" AutoEventWireup="true" CodeBehind="stp_estateList_offers.aspx.cs" Inherits="RentalInRome.WLRental.stp_estateList_offers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_head_top" runat="server">
   <%-- <title><%=ltr_meta_title.Text%></title>
    ...
    <title>Special Offers | <%= App.WLAgent.WL_name %></title>
    <meta name="description" content="Special Offers | <%= App.WLAgent.WL_name %>" />
    <meta name="keywords" content="Special Offers, <%= App.WLAgent.WL_name %>" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_head_bottom" runat="server">
    <script type="text/javascript">
        ...
        function RNT_fillList(action) {
            ...
            var _url = "/webservice/rntEstateOffersList.aspx";
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_main" runat="server">
    ...
    <%--<img src="/images/banner/special_offers_<%=CurrentLang.ABBR.Substring(0,2)%>.png" alt="<%= ltr_title.Text%>" class="bannerSpecOff" />--%>

    <h3 class="underlined" style="margin-left: 14px; margin-top:0;">
      <%= ltr_title.Text%></h3>
    <div class="nulla">
    </div>
    <div id="lista_search" class="zona">
        ...
        <div class="dx">
            <div class="ordina quickSearch" style="width: 555px; display:none;">
