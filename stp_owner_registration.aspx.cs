...
{
    public partial class stp_owner_registration : mainBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                ErrorLog.addLog(_ip, "stp_owner_registration", _params);
        ...
        {
            //AppSettings.RNT_clientConfig _clConfig = new AppSettings.RNT_clientConfig(CURRENT_SESSION_ID);
            //DateTime _dtStart = _clConfig.dtStart;
            //DateTime _dtEnd = _clConfig.dtEnd;
            ...
            //if (IdEstate != 0)
            //    _clConfig.addTo_myPreferedEstateList(IdEstate);
            //_clConfig.Save();
            //// page details
            //CONT_VIEW_STP _stp =
            ...
            //filename = "RiR_" + UrlRewriteTool.ClearPathName(CurrentSource.getSysLangValue("lblTermsAndConditions")) + ".pdf";
            ...
            //filename = "RiR_" + UrlRewriteTool.ClearPathName(CurrentSource.getSysLangValue("lblPrivacyPolicy")) + ".pdf";
            ...
            //}
            //drp_adult.setSelectedValue(_clConfig.num_adult.ToString());
            //drp_child_over.Items.Clear();
            //drp_child_over.Items.Add(new ListItem("---", "0"));
            //for (int i = 1; i <= (_max - _clConfig.num_adult); i++)
            //{
            //    drp_child_over.Items.Add(new ListItem("" + i, "" + i));
            //}
            //drp_child_min.setSelectedValue(_clConfig.num_child_over.ToString());
            ...
            //}
            //drp_child_min.setSelectedValue(_clConfig.num_child_min.ToString());
        ...
        {
            //AppSettings.RNT_clientConfig _clConfig = new AppSettings.RNT_clientConfig(CURRENT_SESSION_ID);
            //_clConfig.dtStart = HF_dtStart.Value.JSCal_stringToDate();
            //_clConfig.dtEnd = HF_dtEnd.Value.JSCal_stringToDate();
            //_clConfig.num_adult = drp_adult.getSelectedValueInt(0).objToInt32();
            //_clConfig.num_child_over = drp_child_over.getSelectedValueInt(0).objToInt32();
            //_clConfig.num_child_min = drp_child_min.getSelectedValueInt(0).objToInt32();
            //_clConfig.Save();
            ...
            //    _rItem.sequence = _clConfig.myPreferedEstateList.IndexOf(id) + 1;
            ...
            //_clConfig.myPreferedEstateList = new List<int>();
            //_clConfig.Save();
            //// end prefenze
            ...
            //_request.request_date_start = _clConfig.dtStart;
            ...
            //_request.request_date_end = _clConfig.dtEnd;
            ...
            //_request.request_adult_num = _clConfig.num_adult;
            ...
            //_request.request_child_num = _clConfig.num_child_over;
            ...
            //_request.request_child_num_min = _clConfig.num_child_min;
            ...
            //string _mSubject = "";
            //int pid_operator = 0;
            //RNT_TBL_REQUEST _relatedRequest = AdminUtilities.rntRequest_getRelatedRequest(_request);
            ...
            //MailingUtilities.autoSendMailTo(_mSubject, _mailBody, MailingUtilities.ADMIN_MAIL, false);
        }
    }
}
