<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="chnlExpediaBeds.aspx.cs" Inherits="MagaRentalCE.admin.modRental.chnlExpediaBeds" %>
                ...
                <asp:ListView ID="LV" runat="server">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            <td>
                                <span>
                                    <%# Eval("pidInternsType")+" " + Eval("code")%></span>
