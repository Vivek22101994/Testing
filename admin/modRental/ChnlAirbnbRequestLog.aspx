<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlAirbnbRequestLog.aspx.cs" Inherits="MagaRentalCE.admin.modRental.ChnlAirbnbRequestLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "ChnlAirbnbRequestLogDett.aspx?id=" + id;
            ...
            <div class="pannello_fascia1">
                ...
                <div style="clear: both">
                    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                        ...
                        <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.dcModRental" TableName="dbRntChnlAirbnbRequestLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                        </asp:LinqDataSource>
                                ...
                                <div class="table_fascia">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr id="Tr1" runat="server" style="">
                                            <th id="Th4" runat="server" width="120px">Data
                                            </th>
                                            <th id="Th1" runat="server" width="150px">Tipo
                                            </th>
                                            <th id="Th5" runat="server" width="">Esito
                                            </th>
