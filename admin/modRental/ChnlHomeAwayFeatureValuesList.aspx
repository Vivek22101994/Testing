<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlHomeAwayFeatureValuesList.aspx.cs" Inherits="ModRental.admin.modRental.ChnlHomeAwayFeatureValuesList" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>HomeAway Feature Values</h1>
                <div class="salvataggio saveAgencyDetails">
                    <div class="bottom_salva">
                        <asp:LinkButton ID="lnkSave" runat="server" OnClick="lnkSave_Click"><span>Salva</span></asp:LinkButton>
                    </div>
                    <div class="nulla">
                    </div>
                    ...
                    <div class="filtro_cont">
                        <table border="0" cellpadding="0" cellspacing="0" id="tbl_new">
                            <tr>
                                ...
                                <td valign="bottom">
                                    <asp:LinkButton ID="lnk_flt" CssClass="ricercaris" runat="server" OnClick="lnk_flt_Click"><span>Filtra</span></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </div>
