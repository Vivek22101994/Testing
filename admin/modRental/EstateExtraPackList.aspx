<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateExtraPackList.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateExtraPackList" %>
...
<script type="text/javascript">
    ...
    function setUrl(type, id) {
        ...
        var url;
        if (type == "dett") {
            url = "EstateExtraPackDett.aspx?id=" + id;
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>Gestione Accessori per Strutture </h1>
            ...
            <div style="clear: both">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntExtrasPackTBs" OrderBy="code" EntityTypeName="">
                </asp:LinqDataSource>
