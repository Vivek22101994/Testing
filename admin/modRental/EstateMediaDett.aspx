<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="EstateMediaDett.aspx.cs" Inherits="ModRental.admin.modRental.EstateMediaDett" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="pnlDett" runat="server">
            ...
            <asp:DropDownList ID="drp_tag" runat="server"></asp:DropDownList>
