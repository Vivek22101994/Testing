<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlHA_media.aspx.cs" Inherits="ModRental.admin.modRental.EstateChnlHA_media" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server" OnAjaxRequest="pnlDett_AjaxRequest">
        <asp:HiddenField ID="HF_type" Value="chnlHA" runat="server" />
        <asp:HiddenField ID="HF_IdEstate" Value="0" runat="server" />
        <asp:HiddenField ID="HF_order" runat="server" />
        <img src="/images/css/homeaway-integrated.jpg" class="homeAwayLogo" alt="Integrated with HA" style="height: 65px; width: 130px;" />
        <h1 class="titolo_main">Multimedia della struttura su HA:
        ...
        <div class="mainline mainChannels mainHALettings mainMediaHA">
            <div class="mainbox">
                <div class="top">
                    <div class="sx">
                    </div>
