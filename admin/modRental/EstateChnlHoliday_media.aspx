<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlHoliday_media.aspx.cs" Inherits="ModRental.admin.modRental.EstateChnlHoliday_media" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server" OnAjaxRequest="pnlDett_AjaxRequest">
        <asp:HiddenField ID="HF_type" Value="chnlHL" runat="server" />
        ...
        <h1 class="titolo_main">
            Multimedia della struttura su HL:
