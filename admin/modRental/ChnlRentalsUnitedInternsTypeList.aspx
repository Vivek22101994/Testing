<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlRentalsUnitedInternsTypeList.aspx.cs" Inherits="RentalInRome.admin.modRental.ChnlRentalsUnitedInternsTypeList" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>RentalsUnited <%# ltrType.Text %> Types</h1>
