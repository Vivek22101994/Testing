<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlHomeAwayAcceptedPaymentForms.aspx.cs" Inherits="ModRental.admin.modRental.ChnlHomeAwayAcceptedPaymentForms" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>HomeAway Accepted Payment Forms</h1>
