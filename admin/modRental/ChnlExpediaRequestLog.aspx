<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlExpediaRequestLog.aspx.cs" Inherits="ModRental.admin.modRental.ChnlExpediaRequestLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "ChnlExpediaRequestLogDett.aspx?id=" + id;
                ...
                <div class="pannello_fascia1">
                    ...
                    <div style="clear: both">
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCchnlExpedia" TableName="dbRntChnlExpediaRequestLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                            </asp:LinqDataSource>
