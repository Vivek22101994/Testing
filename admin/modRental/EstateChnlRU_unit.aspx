<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlRU_unit.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateChnlRU_unit" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table class="tableBoxBooking" cellpadding="0" cellspacing="0" style="width: 60%; min-width:700px;">
                                        <tr>
                                             <td valign="middle" align="left" colspan="4" id="tdAlert" runat="server">
                                                 <span><%= contUtils.getLabel("lblAlertForRuUnit")%></span>
                                             </td>
                                        </tr>
                                        <tr>
