<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master" AutoEventWireup="true" CodeBehind="MediaSequence.aspx.cs" Inherits="ModRental.admin.modRental.MediaSequence" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headTitle" runat="server">
    <title>Cambia ordine delle foto per  <%=ltr_apartment.Text%></title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Literal runat="server" ID="ltr_apartment" Visible="false"></asp:Literal>
    <div id="fascia1" style="min-height: 350px;">
        <div class="pannello_fascia1" id="pnCont" runat="server">
            <div style="clear: both">
                <h1>Cambia ordine delle foto per <%=ltr_apartment.Text%></h1>
                <div class="bottom_agg">
                    ...
                    <a onclick="return CloseRadWindow('reload');" style="float: left; display: inline-block; margin-left: 10px;">
                        <span>Chiudi</span></a>
                </div>
                <div class="nulla">
                </div>
            ...
            <div style="clear: both;">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="RentalInRome.data.magaRental_DataContext" TableName="RNT_RL_ESTATE_MEDIAs" Where="pid_estate == @pid_estate &amp;&amp; type == @type" OrderBy="sequence">
                    <WhereParameters>
                    ...
                    <ItemTemplate>
                        <li class="" refid="<%# Eval("id") %>">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="220px">
                                        <img alt="" width="200px" src="/<%# Eval("img_thumb") %>" />
                                    </td>
                                    <td width="350px">
                                        <%# Eval("code")%>
                                    </td>
