<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlRentalsUnitedPropertyTypeList.aspx.cs" Inherits="RentalInRome.admin.modRental.ChnlRentalsUnitedPropertyTypeList" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>RentalsUnited Property Types</h1>
                        ...
                        <div class="table_fascia">
                            <table border="0" cellpadding="0" cellspacing="0" style="">
                                <tr style="text-align: left">
                                    ...
                                    <th>RentalsUnited Property Type</th>
                                </tr>
