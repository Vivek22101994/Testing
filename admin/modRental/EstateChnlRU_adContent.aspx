<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlRU_adContent.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateChnlRU_adContent" %>
                        ...
                        <div class="boxmodulo">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="salvataggio btnCopia">
                                        <div class="bottom_salva btnCopia">
                                            <asp:LinkButton ID="lnk_copyLang" runat="server" OnClick="lnk_copyLang_Click" CssClass="btnCopia"><span>Copy</span></asp:LinkButton>
                                            <asp:LinkButton Visible="false" ID="lnk_pasteLang" runat="server" OnClick="lnk_pasteLang_Click" CssClass="btnCopia"><span>Paste</span></asp:LinkButton><asp:HiddenField ID="HF_copyLang" Value="0" runat="server" Visible="false" />
                                        </div>
                                    </div>
                                    <%-- </div>--%>
                                                ...
                                                <table cellpadding="3" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">Accommodation Summary:<span class="error_text" id='count_txt_summary' style="display: none"><span class="char"></span>&nbsp;caratteri e&nbsp; <span class="word"></span>&nbsp;parole </span>
                                                            ...
                                                            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txt_summary" ID="RegularExpressionValidator2" ValidationExpression="^[\s\S]{0,80}$" runat="server" ErrorMessage="// 80 caratteri massimo"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            ...
                                                            <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txt_title" ID="RegularExpressionValidator1" ValidationExpression="^[\s\S]{20,}$" runat="server" ErrorMessage="// 20 caratteri minima"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
