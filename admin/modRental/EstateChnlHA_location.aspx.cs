...
{
    public partial class EstateChnlHA_location : adminBasePage
    {
        ...
        protected void fillData()
        {
            using (DCchnlHomeAway dcChnl = new DCchnlHomeAway())
            {
                ...
                //txt_city.Text = locUtils.getCity_title(currEstate.pid_city.objToInt32(), App.DefLangID, "");
        ...
        protected void FillDataFromControls()
        {
            using (DCchnlHomeAway dcChnl = new DCchnlHomeAway())
            {
                ...
                foreach (ListViewDataItem objItem in LV_nearestPlaces.Items)
                {
                    ...
                    var currPoint = dcChnl.dbRntChnlHomeAwayEstatePointsRLs.SingleOrDefault(x => x.pid_estate == IdEstate && x.pid_point == lbl_id.Text.objToInt32());
                    if (drp_distance.getSelectedValueInt() != -1)
                    {
                        ...
                        {
                            currPoint = new dbRntChnlHomeAwayEstatePointsRL();
