<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateZoneSequence.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateZoneSequence" %>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div class="pannello_fascia1" id="pnCont" runat="server">
                    ...
                    <div style="clear: both;">
                        <asp:DropDownList ID="drp_zone" runat="server" OnSelectedIndexChanged="drp_zone_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                    <div style="clear: both;">
                        <asp:HiddenField ID="HF_order" runat="server" />
                        <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="RentalInRome.data.magaRental_DataContext" TableName="RNT_TB_ESTATE" Where="is_active == 1 && is_deleted != 1 && pid_city == @pid_city" OrderBy="zoneSequence">
                            <WhereParameters>
