<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master" AutoEventWireup="true" CodeBehind="step3.aspx.cs" Inherits="ModRental.admin.modRental.newResSteps.step3" %>
            ...
            <asp:Panel ID="pnlContent" runat="server" Width="50%">
                ...
                <div class="salvataggio">
                    <div class="bottom_salva">
                        <asp:LinkButton ID="lnk_save" runat="server" ValidationGroup="dati" OnClick="lnk_save_Click"><span>Salva prenotazione</span></asp:LinkButton>
                    </div>
                    <div class="bottom_salva">
