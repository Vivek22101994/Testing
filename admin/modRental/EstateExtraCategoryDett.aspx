<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master"
    AutoEventWireup="true" CodeBehind="EstateExtraCategoryDett.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateExtraCategoryDett" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server">
        ...
        <asp:HiddenField ID="HfMacroCat" Value="0" runat="server" />
                    ...
                    <div class="boxmodulo">
                        ...
                        <table cellpadding="3" cellspacing="0">
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:DropDownList ID="drp_macroCategory" runat="server">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
