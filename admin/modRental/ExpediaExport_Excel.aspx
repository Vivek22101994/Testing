<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ExpediaExport_Excel.aspx.cs" Inherits="RentalInRome.admin.modRental.ExpediaExport_Excel" %>
                                ...
                                <div class="table_fascia">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" cellpadding="0" cellspacing="0" style="">
                                        <tr id="Tr1" runat="server" style="">
                                            ...
                                            <th id="Th3" runat="server" style="width: 350px;display:none;">
                                                <%-- <asp:LinkButton runat="server" CssClass="lnk_view" Text="Nome &#9660;" ID="lnk_code" OnClick="lnk_code_Click"></asp:LinkButton>--%>
                                                    Booking.com Name 
                                            </th>
