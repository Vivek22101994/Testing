...
{
    public partial class ChnlRentalsUnitedOwnerEdit : adminBasePage
    {
        protected dbRntChnlRentalsUnitedOwnerTBL currTBL;
        ...
        protected void LV_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "del")
            {
                ...
                {
                    currTBL = dc.dbRntChnlRentalsUnitedOwnerTBLs.SingleOrDefault(x => x.id == lbl_id.Text.ToInt64());
                    if (currTBL != null)
                    {
                        dc.Delete(currTBL);
                        dc.SaveChanges();
        ...
        private void fillData()
        {
            using (DCchnlRentalsUnited dc = new DCchnlRentalsUnited())
            {
                currTBL = dc.dbRntChnlRentalsUnitedOwnerTBLs.SingleOrDefault(x => x.id == HfId.Value.ToInt64());

                if (currTBL == null) { currTBL = new dbRntChnlRentalsUnitedOwnerTBL(); currTBL.username = "Default"; }
        ...
        private void saveData()
        {
            using (DCchnlRentalsUnited dc = new DCchnlRentalsUnited())
            {
                ...
                //else if (txt_id.Text != HfId.Value && dc.dbRntChnlRentalsUnitedOwnerTBLs.SingleOrDefault(x => x.id == txt_id.Text.ToInt64()) != null)
                ...
                if (currTBL == null)
                {
                    currTBL = new dbRntChnlRentalsUnitedOwnerTBL();
                    dc.Add(currTBL);
                }
