<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="BcomRequestLog.aspx.cs" Inherits="ModRental.admin.modRental.BcomRequestLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "BcomRequestLogDett.aspx?id=" + id;
                ...
                <div class="pannello_fascia1">
                    ...
                    <div style="clear: both">
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntBcomRequestLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                            </asp:LinqDataSource>
                            ...
                            <ItemTemplate>
                                <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                                    ...
                                    <td>
                                        <span>
                                            <%# Eval("requestContent").ToString().getLines(0).cutString(100)%></span>
                                    </td>
                                    <td>
