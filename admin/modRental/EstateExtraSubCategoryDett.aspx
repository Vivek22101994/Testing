<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master"
    AutoEventWireup="true" CodeBehind="EstateExtraSubCategoryDett.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateExtraSubCategoryDett" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server">
        ...
        <asp:HiddenField ID="HfCat" Value="0" runat="server" />
