<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlRU_bathrooms.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateChnlRU_bathrooms" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="~/admin/modRental/uc/ucRUEstateDetailsTab.ascx" TagName="ucNav" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        <h1 class="titolo_main">Bedrooms of Property for RentalsUnited:<asp:Literal runat="server" ID="ltr_apartment"></asp:Literal>
        </h1>
