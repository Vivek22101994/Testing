...
{
    public partial class ChnlRentalsUnitedAcceptedPaymentForms : adminBasePage
    {
        ...
        private void fillData()
        {
            ...
            {
                var list = dcChnl.dbRntChnlRentalsUnitedAcceptedPaymentFormTBLs.OrderBy(x => x.paymentFormType).ThenBy(x => x.cardCode).ThenBy(x => x.cardType).ToList();
        ...
        protected void lnkSave_Click(object sender, EventArgs e)
        {
            using (DCchnlRentalsUnited dcChnl = new DCchnlRentalsUnited())
            {
                foreach (ListViewDataItem item in LV.Items)
                {
                    ...
                    var featureValuesTbl = dcChnl.dbRntChnlRentalsUnitedAcceptedPaymentFormTBLs.SingleOrDefault(x => x.cardType == lbl_cardType.Text && x.cardCode == lbl_cardCode.Text && x.paymentFormType == lbl_paymentFormType.Text);
