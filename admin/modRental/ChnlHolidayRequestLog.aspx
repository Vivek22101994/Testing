<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlHolidayRequestLog.aspx.cs" Inherits="ModRental.admin.modRental.ChnlHolidayRequestLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "ChnlHolidayRequestLogDett.aspx?id=" + id;
                ...
                <div class="pannello_fascia1">
                    ...
                    <div style="clear: both">
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntChnlHolidayRequestLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                            </asp:LinqDataSource>
