<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true"
    CodeBehind="EstateExtraMacroCategoryList.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateExtraMacroCategoryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function setUrl(type, id) {
            ...
            var url;
            if (type == "dett") {
                url = "EstateExtraMacroCategoryDett.aspx?id=" + id;
        ...
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental"
                    TableName="dbRntExtrasMacroCategoryTBs" OrderBy="code" EntityTypeName="">
                </asp:LinqDataSource>
                <asp:ListView ID="LV" runat="server" DataSourceID="LDS" OnItemCommand="LV_ItemCommand">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                <a href="EstateExtraCategoryList.aspx?id=<%# Eval("id") %>" title="gestire categoria"
                                    style="text-decoration: none; border: 0 none; margin: 5px;">gestire categoria</a>
                            </td>
                        </tr>
                    </ItemTemplate>
