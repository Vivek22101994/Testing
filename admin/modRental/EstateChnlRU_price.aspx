<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateChnlRU_price.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateChnlRU_price" %>
                ...
                <div class="mainbox iCalMainBox">
                    <div class="center">
                        <div class="boxmodulo">
                            ...
                            <table>
                                <tr>
                                    <td class="td_title" style="width: 25%;">Rate 
                                    </td>
                                    <td style="width: 30%">
                                    ...
                                    <td style="width: 10%">
                                        <asp:DropDownList ID="drp_changeIsPercentage" runat="server" Style="height: 25px;width:auto;">
                    ...
                    <div class="center">
                        ...
                        <div class="boxmodulo">
                            <table>
                                ...
                                <tr>
                                    <td class="rntCal nd_f" style="position: relative;" colspan="4">NON disponibile
                                    </td>
                                </tr>
                                <tr>
                                    <td class="rntCal opz_f" style="position: relative;" colspan="4">Prezzo Cambiato
                                    </td>
                                </tr>
                            </table>
