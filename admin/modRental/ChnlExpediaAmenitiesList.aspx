<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ChnlExpediaAmenitiesList.aspx.cs" Inherits="MagaRentalCE.admin.modRental.ChnlExpediaAmenitiesList" %>
                ...
                <asp:ListView ID="LV" runat="server" OnItemCommand="LV_ItemCommand">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="ntxt_price" runat="server" Width="100" ReadOnly="true" Style="text-align: right;" Value="0">
                        ...
                        <div class="table_fascia">
                            <table border="0" cellpadding="0" cellspacing="0" style="">
                                <tr style="text-align: left">
                                    ...
                                    <th></th>
                                    <th style="width: 250px">Price Value</th>
                                </tr>
