<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateExtraCategoryList.aspx.cs" Inherits="RentalInRome.admin.modRental.EstateExtraCategoryList1" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        var rwdUrl = null;
        function setUrl(type, id, macrocategory) {
            if (rwdUrl == null) rwdUrl = $find("<%=rwdUrl.ClientID  %>");

        var url;
        if (type == "dett") {
            if (macrocategory == "") {
                macrocategory = document.getElementById('<%= HfMacroCatId.ClientID %>').value;
            }
            url = "EstateExtraCategoryDett.aspx?id=" + id + "&macrocategory=" + macrocategory;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            <asp:HiddenField ID="HfMacroCatId" Value="0" runat="server" />
            ...
            <div style="clear: both">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntExtrasCategoryTBs" OrderBy="code" EntityTypeName="">
                </asp:LinqDataSource>
                    ...
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                ...
                                <a href="#" onclick="return setUrl('dett', '<%# Eval("id") %>','<%# Eval("pidMacroCategory") %>')" title="Apri Scheda" style="text-decoration: none; border: 0 none; margin: 5px;">Scheda </a>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a href="EstateExtraSubCategoryList.aspx?id=<%# Eval("id") %>" title="gestire sottocategoria" style="text-decoration: none; border: 0 none; margin: 5px;">gestire sottocategoria</a>
                            </td>
                        </tr>
                    </ItemTemplate>
