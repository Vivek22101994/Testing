<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="IcalImportLog.aspx.cs" Inherits="ModRental.admin.modRental.IcalImportLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "IcalImportLogDett.aspx?id=" + id;
            ...
            <div id="fascia1">
                <div class="pannello_fascia1">
                    <div style="clear: both">
                        ...
                        <p>Il log contiene solo ulimi 30 gg</p>
                    </div>
                    <div class="nulla">
				    </div>
                    <div class="filt">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label>
                                                            EstateId:</label>
                                                        <asp:TextBox ID="txt_pidEstate" runat="server" CssClass="inp"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            Errori:</label>
                                                        <asp:DropDownList ID="drp_errorCount" runat="server" CssClass="inp">
                                                            <asp:ListItem Value="1">con errori</asp:ListItem>
                                                            <asp:ListItem Value="0">con successo</asp:ListItem>
                    ...
                    <div style="clear: both">
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntIcalImportLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                            </asp:LinqDataSource>
                            <asp:ListView ID="LV" DataSourceID="LDS" runat="server" OnSelectedIndexChanging="LV_SelectedIndexChanging" OnPagePropertiesChanged="LV_PagePropertiesChanged" ViewStateMode="Disabled">
                            <ItemTemplate>
                                <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                                    ...
                                    <td>
                                        <a href="/admin/modRental/EstateDett_iCalImport.aspx?id=<%# Eval("pidEstate")%>" target="_blank" style="margin: 5px;"><%# Eval("pidEstate")%></a>
                                    </td>
                                    <td>
                                        <span <%# Eval("errorCount").objToInt32()>0?"style='color: #f00;'":"style='color: #0f0;'"%>>
                                            <%# Eval("errorCount")%></span>
                                    </td>
                                    <td>
                            ...
                            <LayoutTemplate>
                                <div class="table_fascia">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr id="Tr1" runat="server" style="">
                                            ...
                                            <th id="Th5" runat="server" width="100px">
                                                Num errori
                                            </th>
                                ...
                                <div class="page">
                                    <asp:DataPager ID="DataPager1" runat="server" PageSize="500" style="border-right: medium none;">
                                        <Fields>
