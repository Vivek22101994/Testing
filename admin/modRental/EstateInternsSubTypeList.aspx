<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateInternsSubTypeList.aspx.cs" Inherits="MagaRentalCE.admin.modRental.EstateInternsSubTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function setUrl(type, id) {
            ...
            var url;
            if (type == "dett") {
                url = "EstateInternsSubTypeDett.aspx?id=" + id;
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1><%# contUtils.getLabel("lblInternsTypeList", App.LangID,"Gestione Sottotipo") %></h1>
            ...
            <div style="clear: both">
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModRental.DCmodRental" TableName="dbRntEstateInternsSubTypeTBs" OrderBy="id" EntityTypeName="">
                </asp:LinqDataSource>
