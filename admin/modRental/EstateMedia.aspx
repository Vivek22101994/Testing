<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="EstateMedia.aspx.cs" Inherits="ModRental.admin.modRental.EstateMedia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="pnlDett" runat="server" OnAjaxRequest="pnlDett_AjaxRequest">
        ...
        <a onclick="goToOriginal();return false;" class="gotopage inlinebtn">Original</a>
        <div class="nulla">
        </div>
        <div class="mainline">
            <!-- BOX 1 -->
            <div class="mainbox">
                ...
                <div class="center">
                    <div id="Div1" class="boxmodulo" runat="server" visible="false">
                        Dimensioni Foto grande:<asp:TextBox ID="txt_imgBigW" runat="server" Width="30" Text="1600"></asp:TextBox>x<asp:TextBox ID="txt_imgBigH" runat="server" Width="30" Text="1200"></asp:TextBox>
                        <br />
                    ...
                    <div class="boxmodulo">
                        <table border="0" cellspacing="3" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <span class="titoloboxmodulo">Aggiungi Foto - dimensione ottimale:
                                        <asp:Literal ID="ltr_imageSize" runat="server"></asp:Literal></span>
                                </td>
                            </tr>
                            <tr style="display:none;">
                                <td>
                                    <span class="titoloboxmodulo" style="color: red;margin-bottom:10px;border-bottom:none!important;font-size:13px;"><%#contUtils.getLabel("lblUseOriginalImages")%></span>
                            ...
                            <tr>
                                <td>
                                    <div id="drag-drop-upload">
                                        ...
                                        <telerik:RadAsyncUpload runat="server" ID="dragDropUpload" MultipleFileSelection="Automatic" InputSize="30" OnFileUploaded="dragDropUpload_FileUploaded" OnClientFilesUploaded="dragDropUpload_fileUploaded" AllowedFileExtensions="jpeg,jpg,gif,png" Enabled="true" />
                                    </div>
                            ...
                            <asp:ListView ID="LV_gallery" runat="server">
                                <ItemTemplate>
                                    <li id="photoitem_<%# Eval("id") %>" imgbig="v" code="<%# Eval("code") %>" refid="<%# Eval("id") %>">
                                        ...
                                        <%# Eval("type")+""=="video"?"<a href=\"#\" onclick=\"OpenShadowbox('EstateMediaDett.aspx?id="+Eval("id")+"');return false;\" class=\"hover-state\"><span>Vedi</span> </a>":"" %>
                                        <%# Eval("type")+""!="video"?"<a href=\"#\" onclick=\"OpenShadowbox('EstateMediaDett.aspx?id="+Eval("id")+"');return false;\" class=\"hover-state\"><span>Vedi</span> </a>":"" %>
                                        <div id="videoContainer_<%# Eval("id") %>" style="display: none;"><%# Eval("video_embed") %></div>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                function goToOriginal() {
                    window.location.href = 'EstateDett_mediaOriginal.aspx?id=<%= IdEstate %>';
                }
                function closeDett() {
                    Shadowbox.close();
