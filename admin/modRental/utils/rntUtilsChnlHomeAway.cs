...
public class ChnlHomeAwayUtils
{
    public static bool CheckForService()
    {
        ...
        if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/booking/"))
        {
            ...
            if (reservationTbl != null)
            {
                ...
                responseContent = ChnlHomeAwayService.Booking(reservationTbl.id);
            }
        }
        if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/bookingupdate/"))
        {
            var uid = Request.Url.LocalPath.ToLower().Replace("/chnlutils/homeaway/bookingupdate/", "");
            var reservationTbl = maga_DataContext.DC_RENTAL.RNT_TBL_RESERVATION.SingleOrDefault(x => x.unique_id.ToString().ToLower() == uid);
            if (reservationTbl != null)
            {
                requestType = "bookingupdate/" + reservationTbl.id;
                responseContent = ChnlHomeAwayService.BookingUpdate(reservationTbl.id);
            }
        }
        if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/listings-rate"))
        {
            requestType = "listings-rate";
            responseContent = ChnlHomeAwayService.ListingRateContentRequest();
        }
        else if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/listings-availability"))
        {
            ...
            responseContent = ChnlHomeAwayService.ListingAvailabilityContentRequest();
        }
        else if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/listings"))
        {
            requestType = "listings";
            responseContent = ChnlHomeAwayService.ListingContentIndexRequest();
        }
        if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/listing/"))
        {
            ...
            using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            {
                ...
                if (estateTb != null && chnlEstateTbl != null)
                {
                    ...
                    responseContent = ChnlHomeAwayService.Listing(estateTb.id);
                }
            }
        }
        else if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/unit-rate/"))
        {
            ...
            using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            {
                ...
                if (estateTb != null && chnlEstateTbl != null)
                {
                    ...
                    responseContent = ChnlHomeAwayService.ListingRate(estateTb.id);
                }
            }
        }
        else if (Request.Url.LocalPath.ToLower().StartsWith("/chnlutils/homeaway/unit-availability/"))
        {
            ...
            using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            {
                ...
                if (estateTb != null && chnlEstateTbl != null)
                {
                    ...
                    responseContent = ChnlHomeAwayService.ListingAvailability(estateTb.id);
                }
            }
        }
    ...
    static void timerChnlHomeAwayImport_ElapsedFirstTime(object sender, System.Timers.ElapsedEventArgs e)
    {
        ...
        if (CommonUtilities.getSYS_SETTING("rntChnlHomeAwayImportFirst") == "true")
            ChnlHomeAwayImport.Enquiries_all(ChnlHomeAwayProps.TimePeriods.PAST_SEVEN_DAYS);
        else
            ChnlHomeAwayImport.Enquiries_all(ChnlHomeAwayProps.TimePeriods.PAST_TWENTY_FOUR_HOURS);
    ...
    static void timerChnlHomeAwayImport_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
    {
        ...
        int rntChnlHomeAwayImportEachMins = CommonUtilities.getSYS_SETTING("rntChnlHomeAwayImportEachMins").ToInt32();
        if (rntChnlHomeAwayImportEachMins == 0) rntChnlHomeAwayImportEachMins = 15;  // each 15 mins default
        ChnlHomeAwayImport.Enquiries_all(ChnlHomeAwayProps.TimePeriods.PAST_THIRTY_MINUTES);
        timerChnlHomeAwayImport.Dispose();
        timerChnlHomeAwayImport = new System.Timers.Timer();
        timerChnlHomeAwayImport.Interval = (1000 * 60 * rntChnlHomeAwayImportEachMins);
        timerChnlHomeAwayImport.Elapsed += new System.Timers.ElapsedEventHandler(timerChnlHomeAwayImport_Elapsed);
...
public static class ChnlHomeAwayProps
{
...
public class ChnlHomeAwayImport
{
    private class Enquiries_process
    {
        ...
        void doThread()
        {
            try
            {
                ...
                {
                    var managerTbl = ModAppServerCommon.utils.getChnlHomeAwayManager(ChnlHomeAwayProps.IdManager);
                    if (managerTbl == null) return;
                    var agentTbl = dcRnt.RntAgentTBL.FirstOrDefault(x => x.isActive == 1 && x.IdAdMedia == ChnlHomeAwayProps.IdAdMedia);
                    if (agentTbl != null)
                        agentID = agentTbl.id;
                    if (agentID == 0) return;
                    ...
                    ChnlHomeAwayClasses.InquirySearchRequest Request = new ChnlHomeAwayClasses.InquirySearchRequest();
                    ...
                    string responseData = ChnlHomeAwayUtils.SendRequest(requesUrl, requestContent, out tmpErrorString);
                    ErrorString = tmpErrorString;
                    if (responseData == "")
                    {
                        requestComments = "ERROR: empty response";
                        ChnlHomeAwayUtils.addLog("ChnlHomeAwayImport.Enquiries_process advertiserAssignedId:" + AdvertiserAssignedId, requestComments, requestContent, responseData, requesUrl);
                        return;
                    }
                    ChnlHomeAwayUtils.addLog("ChnlHomeAwayImport.Enquiries_process advertiserAssignedId:" + AdvertiserAssignedId, requestComments, requestContent, responseData, requesUrl);
                    ChnlHomeAwayClasses.InquirySearchResponse Response = new ChnlHomeAwayClasses.InquirySearchResponse(responseData);
                    ...
                    foreach (var inquiry in advertiser.inquiries)
                    {
                        ...
                        var _request = DC_RENTAL.RNT_TBL_REQUEST.FirstOrDefault(x => x.chnlRefId == inquiry.inquiryId && x.IdAdMedia == ChnlHomeAwayProps.IdAdMedia);
                        if (_request == null)
                        {
                            _request = new RNT_TBL_REQUEST();
                            _request.IdAdMedia = ChnlHomeAwayProps.IdAdMedia;
                    ...
                    ChnlHomeAwayUtils.addLog("ChnlHomeAwayImport.Enquiries_process", requestComments, requestContent, responseData, requesUrl);
                }
            }
            catch (Exception ex)
            {
...
public class ChnlHomeAwayService
{
    ...
    public static string ListingContentIndexRequest()
    {
        ...
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("ListingContentIndexRequest");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                var agentTbl = dc.RntAgentTBL.FirstOrDefault(x => x.isActive == 1 && x.IdAdMedia == ChnlHomeAwayProps.IdAdMedia);
                if (agentTbl != null)
                    agentID = agentTbl.id;
                if (agentID == 0)
                {
                ...
                ChnlHomeAwayClasses.ListingContentIndexResponse Response = new ChnlHomeAwayClasses.ListingContentIndexResponse();
                ...
                if (!string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    var advertiserPPB = new ChnlHomeAwayClasses.Advertiser();
                    advertiserPPB.assignedId = ownerTbl.ppb_advertiserAssignedId;
                    foreach (var estate in estateList)
                    {
                        var entry = new ChnlHomeAwayClasses.ListingContentIndexEntry();
                ...
                if (!string.IsNullOrEmpty(ownerTbl.advertiserAssignedId) && (string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId) || ownerTbl.advertiserAssignedId != ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    estateIds = dcChnl.RntChnlHomeAwayEstateTB.Where(x => x.is_active == 1 && estateIds.Contains(x.id) && x.is_slave != 1).Select(x => (int?)x.id).ToList();
                    estateList = AppSettings.RNT_estateList.Where(x => estateIds.Contains(x.id)).ToList();
                    var advertiserNOPPB = new ChnlHomeAwayClasses.Advertiser();
    ...
    {
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("ListingRateContentRequest");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                ChnlHomeAwayClasses.ListingRateContentResponse Response = new ChnlHomeAwayClasses.ListingRateContentResponse();
                ...
                if (!string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    var advertiserPPB = new ChnlHomeAwayClasses.AdvertiserRate();
                    advertiserPPB.assignedId = ownerTbl.ppb_advertiserAssignedId;
                    foreach (var estate in estateList)
                    {
                        var entry = new ChnlHomeAwayClasses.ListingRateContentEntry();
                ...
                if (!string.IsNullOrEmpty(ownerTbl.advertiserAssignedId) && (string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId) || ownerTbl.advertiserAssignedId != ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    var advertiserNOPPB = new ChnlHomeAwayClasses.AdvertiserRate();
                    advertiserNOPPB.assignedId = ownerTbl.advertiserAssignedId;
                    foreach (var estate in estateList)
                    {
                        var entry = new ChnlHomeAwayClasses.ListingRateContentEntry();
    ...
    public static string ListingAvailabilityContentRequest()
    {
        ...
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("ListingAvailabilityContentRequest");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                ChnlHomeAwayClasses.ListingAvailabilityContentResponse Response = new ChnlHomeAwayClasses.ListingAvailabilityContentResponse();
                ...
                if (!string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    var advertiserPPB = new ChnlHomeAwayClasses.AdvertiserAvailability();
                    advertiserPPB.assignedId = ownerTbl.ppb_advertiserAssignedId;
                    foreach (var estate in estateList)
                    {
                        var entry = new ChnlHomeAwayClasses.ListingAvailabilityContentEntry();
                        var ha_esate = lstEstate_ha.SingleOrDefault(x => x.id == estate.id);
                        entry.listingExternalId = ha_esate.is_slave == 1 ? ha_esate.pid_master_estate + "" : estate.id + "";
                        entry.unitExternalId = estate.id + "";
                        entry.active = true;
                ...
                if (!string.IsNullOrEmpty(ownerTbl.advertiserAssignedId) && (string.IsNullOrEmpty(ownerTbl.ppb_advertiserAssignedId) || ownerTbl.advertiserAssignedId != ownerTbl.ppb_advertiserAssignedId))
                {
                    ...
                    var advertiserNOPPB = new ChnlHomeAwayClasses.AdvertiserAvailability();
                    advertiserNOPPB.assignedId = ownerTbl.advertiserAssignedId;
                    foreach (var estate in estateList)
                    {
                        var entry = new ChnlHomeAwayClasses.ListingAvailabilityContentEntry();
    ...
    {
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("bookingContentIndex");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                if (ownerTbl == null)
                {
                    ...
                    return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "bookingContentIndex");
                }
                var agentTbl = dc.RntAgentTBL.FirstOrDefault(x => x.isActive == 1 && x.IdAdMedia == ChnlHomeAwayProps.IdAdMedia);
                if (agentTbl != null)
                    agentID = agentTbl.id;
                ...
                ChnlHomeAwayClasses.BookingContentIndexRequest Request = new ChnlHomeAwayClasses.BookingContentIndexRequest(xml);
                ...
                ChnlHomeAwayClasses.BookingContentIndexResponse Response = new ChnlHomeAwayClasses.BookingContentIndexResponse();
                ...
                if (Request.advertiser.assignedId == ownerTbl.ppb_advertiserAssignedId && ownerTbl.ppb_advertiserAssignedId != "")
                {
                    ...
                    {
                        var entry = new ChnlHomeAwayClasses.BookingContentIndexEntry();
                        //entry.active = true;
                        ...
                        entry.bookingUpdateUrl = App.HOST_HA + "/chnlutils/homeaway/bookingupdate/" + reservation.unique_id;
    ...
    public static string Listing(int IdEstate)
    {
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
        {
            ...
            if (agentID == 0)
            {
                ...
                return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "bookingResponse");
            }
            ...
            if (currEstate == null)
            {
                return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "quoteResponse");
            }
            ...
            List<string> lstResrtictedLangs = ChnlHomeAwayProps.GetHARestrictedLangs();
            ...
            ChnlHomeAwayClasses.ListingClasses.Listing Response = new ChnlHomeAwayClasses.ListingClasses.Listing();
            ...
            foreach (var unit in Units)
            {
                ...
                var currUnit = new ChnlHomeAwayClasses.ListingClasses.Unit();
                ...
                if (bathRooms.Count == 0) bathRooms = ChnlHomeAwayUtils.getRooms(currEstate, "Bathroom");
                foreach (var room in bathRooms)
                {
                    var tmpRoom = new ChnlHomeAwayClasses.ListingClasses.Bathroom();
                    ...
                    foreach (var featuresString in featuresListString)
                    {
                        ...
                        {
                            ChnlHomeAwayClasses.ListingClasses.Amenity amenity = new ChnlHomeAwayClasses.ListingClasses.Amenity();
                    ...
                    {
                        string pidLang = ChnlHomeAwayProps.GetHALocale(ln.pidLang);
                ...
                if (bedRooms.Count == 0) bedRooms = ChnlHomeAwayUtils.getRooms(currEstate, "Bedroom");
                foreach (var room in bedRooms)
                {
                    var tmpRoom = new ChnlHomeAwayClasses.ListingClasses.Bedroom();
                    tmpRoom.roomSubType = room.roomSubType;
                    var featuresListString = room.features.splitStringToList("|");
                    foreach (var featuresString in featuresListString)
                    {
    ...
    public static string ListingRate(int IdEstate)
    {
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
        {
            ...
            if (agentID == 0)
            {
                ...
                return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "ListingRate");
            }
            var ownerTbl = dcChnl.RntChnlHomeAwayOwnerTBL.FirstOrDefault(x => x.ppb_advertiserAssignedId != "" || x.advertiserAssignedId != "");
            if (ownerTbl == null)
            {
            ...
            ChnlHomeAwayClasses.ListingClasses.unitRateEntities Response = new ChnlHomeAwayClasses.ListingClasses.unitRateEntities();
    ...
    public static string ListingAvailability(int IdEstate)
    {
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
        {
            ...
            if (agentID == 0)
            {
                ...
                return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "ListingAvailability");
            }
            var ownerTbl = dcChnl.RntChnlHomeAwayOwnerTBL.FirstOrDefault(x => x.ppb_advertiserAssignedId != "" || x.advertiserAssignedId != "");
            if (ownerTbl == null)
            {
            ...
            var dtEnd = DateTime.Now.AddYears(2).Date;
            var dtEndTemp = dtEnd.AddDays(1);
            ChnlHomeAwayClasses.ListingClasses.unitAvailabilityEntities Response = new ChnlHomeAwayClasses.ListingClasses.unitAvailabilityEntities();
    ...
    public static string Booking(long id)
    {
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
        {
            ...
            ChnlHomeAwayClasses.BookingResponse Response = new ChnlHomeAwayClasses.BookingResponse();
            ...
            #endregion
            Response.inquirer = new ChnlHomeAwayClasses.Inquirer();
            ...
            var order = new ChnlHomeAwayClasses.Order();
            ...
            var orderItem = new ChnlHomeAwayClasses.OrderItem();
            ...
            // TODO, finalise
            //Part Payment
            var paymentScheduleItem = new ChnlHomeAwayClasses.PaymentScheduleItem();
            ...
            //Balance Payment
            paymentScheduleItem = new ChnlHomeAwayClasses.PaymentScheduleItem();
            ...
            {
                var cancellationPolicyItem = new ChnlHomeAwayClasses.CancellationPolicyItem();
    ...
    public static string BookingUpdate(long id)
    {
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
        {
            ...
            ChnlHomeAwayClasses.BookingResponseUpdate Response = new ChnlHomeAwayClasses.BookingResponseUpdate();
            var reservationTbl = DC_RENTAL.RNT_TBL_RESERVATION.SingleOrDefault(x => x.id == id);
            if (reservationTbl == null)
            {
                return ChnlHomeAwayClasses.ErrorList.GetErrorXml("OTHER", "bookingResponse");
            ...
            #endregion
            Response.inquirer = new ChnlHomeAwayClasses.InquirerUpdate();
            AuthClientTBL clientTbl = dcAuth.AuthClientTBL.SingleOrDefault(x => x.id == reservationTbl.agentClientID);
            if (clientTbl != null)
            {
                Response.inquirer.emailAddress = clientTbl.contactEmail;
            ...
            Response.locale = contUtils.getLang_commonName(reservationTbl.cl_pid_lang.objToInt32()).Replace("-", "_");
            if (string.IsNullOrEmpty(Response.locale)) Response.locale = "en_GB";
            var order = new ChnlHomeAwayClasses.OrderUpdate();
            Response.orderList.Add(order);
            order.currency = "EUR";
    ...
    public static string QuoteRequest(string xml)
    {
        ...
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("quoteResponse");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                ChnlHomeAwayClasses.QuoteRequest Request = new ChnlHomeAwayClasses.QuoteRequest(xml);
                Request.documentVersion = "1.2";
                //for sending resonse
                ...
                ChnlHomeAwayClasses.QuoteResponse Response = new ChnlHomeAwayClasses.QuoteResponse();
                Response.documentVersion = "1.2";
                ...
                var stayFessList = new List<ChnlHomeAwayClasses.StayFees>();
                var stayFess = new ChnlHomeAwayClasses.StayFees();
    ...
    public static string BookingRequest(string xml)
    {
        ...
        long agentID = 0;
        ChnlHomeAwayClasses.ErrorList errorList = new ChnlHomeAwayClasses.ErrorList("bookingResponse");
        ...
        using (magaChnlHomeAwayDataContext dcChnl = maga_DataContext.DC_HOME)
            try
            {
                ...
                ChnlHomeAwayClasses.BookingRequest Request = new ChnlHomeAwayClasses.BookingRequest(xml);
                Request.documentVersion = "1.2";
                var ccData = "";
                ...
                if (orderItem != null)
                {
                    ...
                    //ha fields
                    newRes.IdAdMedia = ChnlHomeAwayProps.IdAdMedia;
...
public class ChnlHomeAwayClasses
{
...
public static class ChnlHomeAwayExts
{
}
