<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_usr_owner_password.ascx.cs" Inherits="RentalInRome.admin.uc.UC_usr_owner_password" %>
...
<asp:HiddenField runat="server" ID="HF_contact_email" Value="" Visible="false" />
<asp:HiddenField runat="server" ID="HF_count_pwd_sent" Value="0" Visible="false" />
<span class="titoloboxmodulo" style="margin-top: 10px;" id="lbl_title" runat="server">Gestione Password del Cliente</span>
<div class="boxmodulo">
    ...
    <table cellpadding="1" cellspacing="2" style="margin-bottom: 1px">
        <tr>
            <td>
               <%=(HF_count_pwd_sent.Value.ToInt32() != 0 ? "Notifica PWD al cliente inviata " + HF_count_pwd_sent.Value.ToInt32() + " volta/e" : "")%>
            </td>
        </tr>
    </table>
</div>
