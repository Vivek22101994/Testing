...
{
    public partial class UC_usr_owner_password : System.Web.UI.UserControl
    {
        protected magaUser_DataContext DC_USER;
        protected USR_TBL_OWNER _currTBL;
        public int IdOwner
        {
            get
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                pnl_pwd.Visible = UserAuthentication.CURRENT_USER_ROLE == 1;
            }
        }
        private void FillControls()
        {
            ...
            if (IdOwner != 0)
            {
                _currTBL = DC_USER.USR_TBL_OWNER.SingleOrDefault(x => x.id == IdOwner);
            }
            if (_currTBL == null)
            {
                this.Visible = false;
            ...
            HF_count_pwd_sent.Value = _currTBL.count_pwd_sent.objToInt32().ToString();
            DisableControls();
        }
        ...
        {
            lbl_title.InnerHtml = "Gestione Password del Utente";
        ...
        {
            lbl_title.InnerHtml = "Cambio Password del Utente";
        ...
        protected void lnk_send_pwd_Click(object sender, EventArgs e)
        {
            ...
            _currTBL.count_pwd_sent = _currTBL.count_pwd_sent.objToInt32() + 1;
            DC_USER.SubmitChanges();
            bool alternateOld = true;
            string _mailBody = "";
            _mailBody += MailingUtilities.addMailRow("Messaggio di notifica password", "<br/>di seguito credenziali di accesso in area riservata per i proprietari delle strutture del sito RentalInRome.com", alternateOld, out alternateOld, true, false, true);
            ...
            if (MailingUtilities.autoSendMailTo("RiR | Notifica Password", _mailBody, HF_contact_email.Value, false, "admin_uc_UC_usr_owner_password"))
