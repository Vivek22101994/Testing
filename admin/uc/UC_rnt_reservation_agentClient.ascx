<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_rnt_reservation_agentClient.ascx.cs" Inherits="RentalInRome.admin.uc.UC_rnt_reservation_agentClient" %>
...
<asp:HiddenField ID="HF_country" runat="server" />
...
<div class="box_client_booking" id="pnl_sendBooking" runat="server" style="overflow: hidden; position: relative;">
    ...
    <div class="titflag">
        <div>
            <span>Dati del Cliente di Agenzia</span>
        </div>
    </div>
    <asp:PlaceHolder ID="PH_bookingForm" runat="server">
        <asp:PlaceHolder ID="PH_viewClient" runat="server">
            ...
            <asp:Literal ID="ltr_city" runat="server" Visible="false"></asp:Literal>
            <asp:Literal ID="ltr_address" runat="server" Visible="false"></asp:Literal>
            <asp:Literal ID="ltr_zip_code" runat="server" Visible="false"></asp:Literal>
            <asp:Literal ID="ltr_doc_number" runat="server" Visible="false"></asp:Literal>
            <asp:Literal ID="ltr_issue_date" runat="server" Visible="false"></asp:Literal>
            ...
            <div class="line">
                <div id="Div16" class="left">
                    ...
                    <div>
                        <input type="text" style="width: 120px" value="<%=ltr_address.Text %>" readonly="readonly" />
                    </div>
                </div>                
                <div class="nulla">
                </div>
            ...
            <div class="line">
                <div id="Div3" class="left">
                    ...
                    <div>
                        <input type="text" style="width: 120px" value="<%=ltr_city.Text %>" readonly="readonly" />
                    </div>
                </div>
                <div id="Div8" class="left">
                    ...
                    <div>
                        <input type="text" style="width: 350px" value="<%=ltr_zip_code.Text %>" readonly="readonly" />
                    </div>
                </div>
                <div class="nulla">
                </div>
            ...
            <div class="line">
                <div id="Div14" class="left">
                    ...
                    <div>
                        <input type="text" style="width: 120px" value="<%=ltr_doc_number.Text %>" readonly="readonly" />
                    </div>
                </div>
                <div id="Div15" class="left">
                    ...
                    <div>
                        <input type="text" style="width: 350px" value="<%=ltr_issue_date.Text %>" readonly="readonly" />
                    </div>
                </div>
                <div class="nulla">
                </div>
        ...
        <asp:PlaceHolder ID="PH_newClient" runat="server">
            ...
            <div class="line">
                <div id="Div9" class="left">
                    ...
                    <div>
                        <asp:TextBox ID="txt_city" runat="server" Style="width: 300px;"></asp:TextBox>
                    </div>
                </div>
                <div id="Div10" class="left">
                    ...
                    <div>
                        <asp:TextBox ID="txt_zip_code" runat="server" Style="width: 300px;"></asp:TextBox>
                    </div>
                </div>
                <div class="nulla">
                </div>
            ...
            <div class="line">
                <div id="Div12" class="left">
                    ...
                    <div>
                        <asp:TextBox ID="txt_docNum" runat="server" Style="width: 300px;"></asp:TextBox>
                    </div>
                </div>
    ...
    <asp:PlaceHolder ID="PH_oldClient" runat="server">
        ...
        <div class="risric">
            ...
            <asp:LinqDataSource ID="LDS_flt" runat="server" ContextTypeName="ModAuth.DCmodAuth" TableName="dbAuthClientTBLs" OrderBy="nameFull">
            </asp:LinqDataSource>
            <div class="nulla">
            </div>
        </div>
