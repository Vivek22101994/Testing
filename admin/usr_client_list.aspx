<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="usr_client_list.aspx.cs" Inherits="RentalInRome.admin.usr_client_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script type="text/javascript">
		...
		function Filter() {
			...
			_value = $get("<%= drp_showPren.ClientID%>").value;
			if (_value != "")
			    _filter += "&showpren=" + _value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
											...
											<td>
												<table border="0" cellpadding="0" cellspacing="0">
													<tr>
                                                        ...
                                                        <td>
                                                            <label>
                                                                Visualizza se ha Pren.</label>
                                                            <asp:DropDownList runat="server" ID="drp_showPren" CssClass="inp" Width="120px">
                                                                <asp:ListItem Value="0">No</asp:ListItem>
                                                                <asp:ListItem Value="1">Si</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
					...
					<div style="clear: both">
						<asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
							<ContentTemplate>
								...
								<asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="RentalInRome.data.magaUser_DataContext" TableName="USR_TBL_CLIENTs" OrderBy="name_full">
								</asp:LinqDataSource>
								<asp:ListView ID="LV" runat="server" DataSourceID="LDS" Visible="false" OnDataBound="LV_DataBound" OnItemCommand="LV_ItemCommand">
									<ItemTemplate>
										<tr class="" onmouseout="SetClassName(this,'')" onmouseover="SetClassName(this,'current')">
                                            ...
                                            <td>
                                                <asp:Literal ID="ltrPrenSiNo" runat="server"><span>- - -</span></asp:Literal>
                                            </td>
											<td>
												<span>
											...
											<td>
												...
												<a href="usr_client_details.aspx?id=<%# Eval("id") %>" style="margin-top: 6px; margin-right: 5px;">dettagli</a>
											</td>
										</tr>
									</ItemTemplate>
	...
	<script type="text/javascript">
		...
		function setCal() {
			cal_date_created_from = new JSCal.Single({ dtFormat: "d MM yy", Cont: "#<%= HF_date_created_from.ClientID %>", View: "#cal_date_created_from", Cleaner: "#del_date_created_from", changeMonth: true, changeYear: true });
			cal_date_created_to = new JSCal.Single({ dtFormat: "d MM yy", Cont: "#<%= HF_date_created_to.ClientID %>", View: "#cal_date_created_to", Cleaner: "#del_date_created_to", changeMonth: true, changeYear: true });
