<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="rnt_estate_calendar.aspx.cs" Inherits="RentalInRome.admin.rnt_estate_calendar" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h1 class="titolo_main" style="color: #FE6634;">
                Gestione prenotazioni e disponibilità della struttura:
                ...
                <div class="pannello_fascia1">
                    <div style="clear: both">
                        ...
                        <div class="filt">
                            ...
                            <div class="c">
                                <h1>
                                    Nuova disponibilità del proprietario
                                </h1>
                                <div class="nulla">
                                </div>
                            ...
                            <div class="boxmodulo">
                                <table border="0" cellspacing="3" cellpadding="0">
                                    <tr>
                                        ...
                                        <td>
                                            &euro;&nbsp;<asp:TextBox ID="txt_price_1" runat="server" Style="width: 80px"></asp:TextBox>
                                        ...
                                        <td>
                                            &euro;&nbsp;<asp:TextBox ID="txt_price_optional_1" runat="server" Style="width: 80px"></asp:TextBox>
