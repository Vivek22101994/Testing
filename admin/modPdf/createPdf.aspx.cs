    ...
    public partial class createPdf : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(_serverPath))
                pdfUtils.downloadPdfFromUrl(_url, _filename, 0.3f, 0.3f, 0.3f, 0.3f);
            else
            {
                Response.Write(pdfUtils.savePdfFromUrl(_url, _serverPath, 0.3f, 0.3f, 0.3f, 0.3f));
            }
        }
    }
}