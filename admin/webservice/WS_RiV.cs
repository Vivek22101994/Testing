...
public class RiV_WS
{
    ...
    {
        //Action<object> action = (object obj) => { fillRewriteTool(); };
    ...
    public static void Thread_fillRewriteTool()
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiV_WS.fillRewriteTool", ex.ToString()); }
    }
    public static void refreshCache(string Mode)
    {
        mode = Mode;
        //Action<object> action = (object obj) => { Thread_refreshCache(); };
        //AppUtilsTaskScheduler.AddTask(action, "Thread_refreshCache");
    ...
    public static void Thread_refreshCache()
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiV_WS.refreshCache", ex.ToString()); }
    }
    public static void rntReservation_onChange(long ResId)
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiV_WS.rntReservation_onChange " + ResId, ex.ToString()); }
    }
}
