...
public class RiF_WS
{
    ...
    public static void Thread_fillRewriteTool()
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiF_WS.fillRewriteTool", ex.ToString()); }
    }
    ...
    public static void Thread_refreshCache()
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiF_WS.refreshCache", ex.ToString()); }
    }
    public static void rntReservation_onChange(long ResId)
    {
        ...
        catch (Exception ex) { ErrorLog.addLog("", "RiF_WS.rntReservation_onChange " + ResId, ex.ToString()); }
    }
}
