<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_adminNoMenu.Master" AutoEventWireup="true" CodeBehind="articleDett.aspx.cs" Inherits="ModBlog.admin.modBlog.articleDett" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server">
                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    <table cellpadding="1" cellspacing="2" style="margin-bottom: 1px">
                                        <tr>
                                            <td colspan="2">
                                                <span class="titoloboxmodulo" style="margin-bottom: 0px;">Dati essenziali</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="drp_pidCategory" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="drp_createdUserID" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                            <td style="width: 20px;">
                                            </td>
                                            ...
                                            <td>
                                                <telerik:RadDatePicker ID="rdp_publicDate" runat="server" Width="100px" CssClass="inp">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <span class="titoloboxmodulo" style="margin-bottom: 0px;">Blog strade</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_title">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="drp_pidZone" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr runat="server" visible="false">
                                <td style="vertical-align: top;">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <span class="titoloboxmodulo" style="margin-bottom: 0px;">Categorie</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="boxmodulo">
                                                    <asp:CheckBoxList ID="chkList_ArticleCategoryRL" runat="server" RepeatColumns="4" RepeatDirection="Horizontal">
                                                    </asp:CheckBoxList>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <span class="titoloboxmodulo" style="margin-bottom: 0px;">Tag correlazione</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="boxmodulo">
                                                    <asp:CheckBoxList ID="chkList_ArticleTagRL" runat="server" RepeatColumns="4" RepeatDirection="Horizontal">
                                                    </asp:CheckBoxList>
                                                </div>
                                            </td>
                                        </tr>
        ...
        <div class="mainline" id="pnlImg" runat="server" visible="false">
