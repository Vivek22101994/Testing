<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="ArticleMedia.aspx.cs" Inherits="ModBlog.admin.modBlog.ArticleMedia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="pnlDett" runat="server" OnAjaxRequest="pnlDett_AjaxRequest">
        <asp:HiddenField ID="HF_IdArticle" Value="0" runat="server" />
        <asp:HiddenField ID="HF_order" runat="server" />
        <asp:HiddenField ID="HF_currFolder" runat="server" />
        <h1 class="titolo_main">
            Multimedia del articolo:
            <asp:Literal runat="server" ID="ltr_apartment"></asp:Literal>
        </h1>
        <div class="salvataggio">
            <div class="bottom_salva">
                <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                    <a href="articleList.aspx?id=<%= HF_IdArticle.Value %>"><span>Scheda dell'articolo</span></a>
                </telerik:RadCodeBlock>
            </div>
            <div class="bottom_salva">
                <a href="articleList.aspx"><span>Torna nella lista</span></a>
            </div>
            <div class="nulla">
            </div>
        </div>
            ...
            <div class="mainbox">
                ...
                <div class="center">
                    <div id="Div1" class="boxmodulo" runat="server" visible="false">
                        Dimensioni Foto grande:<asp:TextBox ID="txt_imgBigW" runat="server" Width="30" Text="564"></asp:TextBox>x<asp:TextBox ID="txt_imgBigH" runat="server" Width="30" Text="317"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <br />
                        Dimensioni Foto piccola:<asp:TextBox ID="txt_imgSmallW" runat="server" Width="30" Text="138"></asp:TextBox>x<asp:TextBox ID="txt_imgSmallH" runat="server" Width="30" Text="138"></asp:TextBox>
                        <br />
                    ...
                    <div class="boxmodulo">
                        <table border="0" cellspacing="3" cellpadding="0">
                            <tr>
                                <td>
                                    <span class="titoloboxmodulo">Aggiungi Foto </span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <asp:ListView ID="LV_gallery" runat="server">
                                <ItemTemplate>
                                    <li id="photoitem_<%# Eval("id") %>" imgbig="v" code="<%# Eval("code") %>" refid="<%# Eval("id") %>">
                                        ...
                                        <a href="#" onclick="OpenShadowbox('ArticleMediaDett.aspx?id=<%# Eval("id") %>');
