...
{
    public partial class rnt_residence_gmap_sv : adminBasePage
    {
        ...
        {
            RNT_TB_RESIDENCE _d = DC_RENTAL.RNT_TB_RESIDENCEs.SingleOrDefault(x => x.id == Convert.ToInt32(HF_id.Value));
            if (_d == null)
            {
