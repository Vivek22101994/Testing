<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="loc_pointtype_details.aspx.cs" Inherits="RentalInRome.admin.loc_pointtype_details" %>
            ...
            <div class="mainline">
                ...
                <div class="mainbox">
                    ...
                    <div class="center">
                        ...
                        <div class="boxmodulo">
                            <uc1:UC_get_image ID="UC_get_img_thumb" runat="server" ShowCrop="false" ImgRoot="images/travelpoints/types" />
                        </div>
                    </div>
                    <div class="bottom">
                        <div style="float: left;">
