<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="util_MailErrorLog.aspx.cs" Inherits="RentalInRome.admin.util_MailErrorLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "util_MailErrorLogDett.aspx?id=" + id + "&dt=" + $("#<%= drp_logList.ClientID%>").val();
                ...
                <div class="pannello_fascia1">
                    <div style="clear: both">
                        ...
                        <div class="bottom_agg">
                            <asp:LinkButton ID="lnk_resendAll" runat="server" OnClick="lnk_resendAll_Click" Visible="false"><span>Reinvia tutti</span></asp:LinkButton>
                        </div>
                    </div>
                    <div class="nulla">
				    </div>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label>
                                                            Subject:</label>
                                                        <asp:TextBox ID="txt_Subject" runat="server" CssClass="inp"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <ItemTemplate>
                                <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                                    ...
                                    <td>
                                        <%# ((bool)Eval("isResent")) ? "<span style=\"color: #0f0;\">SI</span>" : "<span style=\"color: #f00;\">NO</span>"%>
                                    </td>
                                    <td>
                                ...
                                <div class="table_fascia">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr id="Tr1" runat="server" style="">
                                            ...
                                            <th id="Th6" runat="server" style="min-width: 200px;">Tipo mail </th>
                                            <th id="Th5" runat="server" style="min-width: 200px;">
                                                Subject
                                            </th>
                                            <th id="Th1" runat="server" style="width: 80px;">Reinviato? </th>
