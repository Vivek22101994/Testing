<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="rnt_estate_gmap_sv.aspx.cs" Inherits="RentalInRome.admin.rnt_estate_gmap_sv" %>

<%@ Register Src="~/admin/uc/UC_rnt_estate_navlinks.ascx" TagName="UC_rnt_estate_navlinks" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&language=<%=CurrentLang.ABBR.Substring(0,2)%>"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="titolo_main">Gestione StreetView della struttura: <asp:Literal ID="ltr_title" runat="server"></asp:Literal></h1>
    <div id="fascia1">
