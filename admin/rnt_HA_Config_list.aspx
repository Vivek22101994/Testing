<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="rnt_HA_Config_list.aspx.cs" Inherits="RentalInRome.admin.rnt_HA_Config_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="RentalInRome.data.magaRental_DataContext" TableName="RNT_TB_HACONFIG" OrderBy="inner_notes">
                <WhereParameters>
                ...
                <div class="pannello_fascia1">
                    <div style="clear: both">
                        ...
                        <div class="bottom_agg">
                            <asp:LinkButton ID="lnk_nuovo" Visible="true" runat="server" OnClick="lnk_nuovo_Click" OnClientClick="removeTinyEditor();"><span>+ Nuovo</span></asp:LinkButton>
                        </div>
                    </div>
                    <div style="clear: both">
