<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="langEdit.aspx.cs" Inherits="ModContent.admin.modContent.langEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="RentalInRome.data.magaContent_DataContext" TableName="CONT_TBL_LANGs" OrderBy="id" EntityTypeName="">
                </asp:LinqDataSource>
                <asp:ListView ID="LV" runat="server" DataSourceID="LDS" OnItemCommand="LV_ItemCommand">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                <span>
                                    <%# Eval("lang_title")%></span>
                            </td>
                            <td>
                                <span>
                                    <%# Eval("common_name")%></span>
                            </td>
                             <td>
                                <span>
                                    <%# Eval("HACode")%></span>
                        ...
                        <div class="table_fascia">
                            <table border="0" cellpadding="0" cellspacing="0" style="">
                                <tr style="text-align: left">
                                    ...
                                    <th style="width: 30px">Abbr </th>
                                    <th style="width: 150px">Nome </th>
                                    <th style="width: 150px">Nome in Lingua </th>
                                    <th style="width: 60px">CultureInfo </th>
                                    <th style="width: 60px">HACode(Fixed as per HomeAway) </th>
                                    <th style="width: 50px">Pubblico? </th>
                    ...
                    <telerik:RadAjaxPanel ID="pnlDett" runat="server">
                        ...
                        <div class="mainline">
                                    ...
                                    <div class="boxmodulo">
                                        <table cellpadding="1" cellspacing="2" style="margin-bottom: 1px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="drp_isPublic" runat="server">
                                                        <asp:ListItem Value="1">SI</asp:ListItem>
                                                        <asp:ListItem Value="0">NO</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_langTitle" Width="230px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_title">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_commonName" Width="230px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_title">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_abbr" Width="230px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_title">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_jsCalFile" Width="230px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_title">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_imgThumb" Width="230px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_title">
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txt_imgPreview" Width="230px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <div class="salvataggio">
                                ...
                                <div class="bottom_salva">
                                    <a onclick="return rwdDettClose();"><span>
                                        Chiudi</span></a>
                                </div>
                                <div class="nulla">
                                </div>
