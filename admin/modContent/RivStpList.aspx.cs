...
{
    public partial class RivStpList : adminBasePage
    {
        ...
        protected void LV_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "del")
            {
                ...
                {
                    currTBL = dc.dbRivContStpTBs.SingleOrDefault(x => x.id == lbl_id.Text.ToInt32());
                    if (currTBL != null)
                    {
        ...
        private void fillData()
        {
            using (DCmodContent dc = new DCmodContent())
            {
                ...
                if (currTBL == null) currTBL = new dbRivContStpTB();
