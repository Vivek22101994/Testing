<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="cont_tour_item_details.aspx.cs" Inherits="RentalInRome.admin.cont_tour_item_details" %>
                        ...
                        <div class="boxmodulo">
                            <table cellpadding="1" cellspacing="2" style="margin-bottom: 1px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drp_tour" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
