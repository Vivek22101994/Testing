<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="rnt_reservation_details_manuale.aspx.cs" Inherits="RentalInRome.admin.rnt_reservation_details_manuale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel_main" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="main">
                <span class="titlight">Dettagli della Prenotazioni #<%= HF_code.Value %></span>
                <div class="mainline">
                    <div class="prices">
                        ...
                        <div class="fasciatitBar" style="overflow: hidden; position: relative;" runat="server" visible="false">
                            <div id="Div7" runat="server" visible="false" style="background-image: url('images/lock.png'); width: 2000px; height: 2000px; margin: -200px; position: absolute; z-index: 2;">
                            </div>
                            <div>
                                <h3>Dati Booking.com
                                </h3>
                                <div class="price_div">
                                    <table cellpadding="1" cellspacing="2" style="margin-bottom: 1px">
                                        <tr>
                                            ...
                                            <td><%= tblReservation.bcom_extrainfo %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_facilities
                                            </td>
                                            <td><%= tblReservation.bcom_facilities %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_info
                                            </td>
                                            <td><%= tblReservation.bcom_info %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_mealplan
                                            </td>
                                            <td><%= tblReservation.bcom_mealplan %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_maxChidren
                                            </td>
                                            <td><%= tblReservation.bcom_maxChidren %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_smoking
                                            </td>
                                            <td><%= tblReservation.bcom_smoking %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_loyalityid
                                            </td>
                                            <td><%= tblReservation.bcom_loyalityid %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_guest_name
                                            </td>
                                            <td><%= tblReservation.bcom_guest_name %></td>
                                        </tr>
                                        <tr>
                                            <td>bcom_room_remarks
                                            </td>
                                            <td><%= tblReservation.bcom_room_remarks %></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="nulla">
                        ...
                        <div class="fasciatitBar" style="overflow: hidden; position: relative;">
                            ...
                            <div class="price_div">
                                ...
                                <asp:LinkButton ID="lnk_pricesEdit" runat="server" CssClass="changeapt" OnClick="lnk_pricesEdit_Click">Cambia i Prezzi</asp:LinkButton>
                                <asp:LinkButton ID="lnk_pricesSave" runat="server" CssClass="changeapt" OnClick="lnk_pricesSave_Click">Salva i Prezzi</asp:LinkButton>
                                <asp:LinkButton ID="lnk_pricesCancel" runat="server" CssClass="changeapt" OnClick="lnk_pricesCancel_Click">Annulla</asp:LinkButton>
                                <asp:LinkButton ID="lnk_pricesDaTariffa" runat="server" CssClass="changeapt" OnClick="lnk_pricesDaTariffa_Click">Prezzi ta tariffa</asp:LinkButton>
