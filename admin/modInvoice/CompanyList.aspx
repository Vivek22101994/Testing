<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="CompanyList.aspx.cs" Inherits="ModInvoice.admin.modInvoice.CompanyList" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>Gestione Societa di fatturazione </h1>
            ...
            <div style="clear: both">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModInvoice.DCmodInvoice" TableName="dbInvCompanyTBLs" OrderBy="docIssueDate desc" EntityTypeName="">
                </asp:LinqDataSource>
                <asp:ListView ID="LV" runat="server" DataSourceID="LDS" OnItemCommand="LV_ItemCommand">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                <span>
                                    <%# Eval("isForReservations") + "" == "1" ? "SI" : "NO"%></span>
                            </td>
                            <td>
                                <span>
                                    <%# Eval("isForAgencies") + "" == "1" ? "SI" : "NO"%></span>
                            </td>
                            <td>
                                <span>
                        ...
                        <div class="table_fascia">
                            <table border="0" cellpadding="0" cellspacing="0" style="">
                                <tr style="text-align: left">
                                    ...
                                    <th style="width: 40px;">Prenotazioni private </th>
                                    <th style="width: 40px;">Agenzie </th>
