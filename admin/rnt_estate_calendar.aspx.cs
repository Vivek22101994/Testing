...
{
    public partial class rnt_estate_calendar : adminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                lnk_save.Visible = lnk_annulla.Visible = lnkNew.Visible = UserAuthentication.hasPermission("rnt_estate", "can_edit");
                int id = Request.QueryString["id"].ToInt32();
                RNT_TB_ESTATE _est = DC_RENTAL.RNT_TB_ESTATE.SingleOrDefault(x => x.id == id);
                if (_est != null)
                {
                    IdEstate = _est.id;
        ...
        protected void LV_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (lbl_state.Text == "4")
            {
                ...
                if (_currRes != null)
                {
                    string url_voucher = CurrentAppSettings.HOST_SSL + CurrentAppSettings.ROOT_PATH + "pdfgenerator/pdf_rnt_reservation_voucher.aspx?uid=" + _currRes.uid_2;
            ...
            lnk_cancel.Visible = lbl_state.Text == "2";
        ...
        protected void LV_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "cancella")
            {
                ...
                _currTBL.state_subject = "Cancellato";
                _currTBL.state_body = "";
                _currTBL.state_date = DateTime.Now;
                DC_RENTAL.SubmitChanges();
                rntUtils.rntReservation_onChange(_currTBL);
