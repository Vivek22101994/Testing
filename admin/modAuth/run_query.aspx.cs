...
{
    public partial class run_query : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "hideloder", "hideLoader();", true);
            }
        }
        ...
        protected void btnRun_Click(object sender, EventArgs e)
        {
            ...
            grdResult.DataBind();
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "hide_Loder", "hideLoader();", true);
