<%@ Page Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="userReportList.aspx.cs" Inherits="ModAuth.admin.modAuth.userReportList" %>
    ...
    <div id="fascia1">
        <telerik:RadAjaxPanel ID="pnlFascia" runat="server" CssClass="pannello_fascia1" OnAjaxRequest="pnlFascia_AjaxRequest">
            ...
            <div style="clear: both">
                <h1>Gestione Report degli Account (Produttori) </h1>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td id="pnl_flt_pidReferer" runat="server" visible="false">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="drp_flt_pidUser" CssClass="inp" Width="120px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        <label>Tipo:</label>
                                                        <asp:DropDownList ID="drp_flt_repType" runat="server" CssClass="inp">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        <label>Registrato da:</label>
                                                        <telerik:RadDatePicker ID="rdp_flt_repDateTimeFrom" runat="server" Width="100px" CssClass="inp">
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadDatePicker ID="rdp_flt_repDateTimeTo" runat="server" Width="100px" CssClass="inp">
                                                            <DateInput DateFormat="dd/MM/yyyy">
                                                            </DateInput>
                                                        </telerik:RadDatePicker>
                                                    </td>
            ...
            <div style="clear: both">
                ...
                <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModAuth.DCmodAuth" TableName="dbAuthUserReportTBLs" OrderBy="repDateTime desc" EntityTypeName="">
                </asp:LinqDataSource>
                <asp:ListView ID="LV" runat="server" DataSourceID="LDS" OnItemCommand="LV_ItemCommand">
                    <ItemTemplate>
                        <tr class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                            ...
                            <td>
                                <span>
                                    <%# AdminUtilities.usr_adminName(Eval("pidUser").objToInt32(), "- - -")%></span>
                            </td>
                            <td>
                                <span>
                                    <%# authUtils.getUserReportType_title("" + Eval("repType"), "- - -")%></span>
                            </td>
                            <td>
                                <span>
                                    <%# Eval("repTitle")%></span>
                        ...
                        <div class="table_fascia">
                            <table border="0" cellpadding="0" cellspacing="0" style="">
                                <tr style="text-align: left">
                                    ...
                                    <th style="width: 150px">Titolo </th>
