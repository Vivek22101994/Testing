<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/admin/common/MP_admin.Master" AutoEventWireup="true" CodeBehind="errorSrsLog.aspx.cs" Inherits="ModAuth.admin.modAuth.errorSrsLog" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function rwdDettOpen(id) {
                ...
                url = "errorSrsLogDett.aspx?id=" + id;
                ...
                <div class="pannello_fascia1">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" id="tbl_new">
                                    <tr>
                                        ...
                                        <td valign="bottom">
                                            ...
                                            <asp:LinkButton ID="lnk_Resend_all" runat="server" CssClass="ricercaris" OnClick="lnk_Resend_all_Click"> <%=contUtils.getLabel("lblResendAll") %></asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div style="clear: both">
                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                            ...
                            <asp:LinqDataSource ID="LDS" runat="server" ContextTypeName="ModAuth.DCmodAuth" TableName="dbAuthErrorSrsLOGs" OrderBy="logDateTime desc" EntityTypeName="">
                            </asp:LinqDataSource>
                            ...
                            <ItemTemplate>
                                <tr ip="<%# Eval("logIp")%>" class="" onmouseover="$(this).addClass('tr_current');" onmouseout="$(this).removeClass('tr_current');">
                                    ...
                                    <td>
                                        <a href="errorSrsLog.aspx?resend=<%# Eval("uid")%>" style="margin: 5px;">reinvia</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
