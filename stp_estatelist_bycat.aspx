<%@ Page Title="" Language="C#" MasterPageFile="~/common/MP_main.Master" AutoEventWireup="true" CodeBehind="stp_estatelist_bycat.aspx.cs" Inherits="RentalInRome.stp_estatelist_bycat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_head_bottom" runat="server">
    ...
    <script type="text/javascript">
        ...
        function RNT_fillList(action) {
            ...
            var _url = "/webservice/rnt_estate_list_bycat.aspx";
            _url += "?action=" + action;
