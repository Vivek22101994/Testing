...
{
    public partial class stpLandingSimposio : mainBasePage
    {
        ...
        protected void lnk_search_Click(object sender, EventArgs e)
        {
            ...
            //ScriptManager.RegisterStartupScript(this, typeof(string), CommonUtilities.newUniqueID(), "window.open('" + CurrentSource.getPagePath("6", "stp", CurrentLang.ID.ToString()) + "','_blank');", true);
            //ScriptManager.RegisterStartupScript(this, typeof(string), CommonUtilities.newUniqueID(), "openNewSearch()", true);
        }
    }
}